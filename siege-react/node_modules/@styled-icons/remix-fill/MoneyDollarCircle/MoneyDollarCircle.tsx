...
export const MoneyDollarCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MoneyDollarCircleDimensions = {height: 24, width: 24}
