...
export const WechatPay: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WechatPayDimensions = {height: 24, width: 24}
