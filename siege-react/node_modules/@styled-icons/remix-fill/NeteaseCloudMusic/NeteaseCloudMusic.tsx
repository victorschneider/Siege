...
export const NeteaseCloudMusic: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NeteaseCloudMusicDimensions = {height: 24, width: 24}
