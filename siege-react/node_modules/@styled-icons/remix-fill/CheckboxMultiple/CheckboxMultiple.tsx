...
export const CheckboxMultiple: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckboxMultipleDimensions = {height: 24, width: 24}
