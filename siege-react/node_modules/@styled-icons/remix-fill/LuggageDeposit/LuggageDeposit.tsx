...
export const LuggageDeposit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LuggageDepositDimensions = {height: 24, width: 24}
