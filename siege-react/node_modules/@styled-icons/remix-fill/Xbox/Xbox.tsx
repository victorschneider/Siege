...
export const Xbox: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const XboxDimensions = {height: 24, width: 24}
