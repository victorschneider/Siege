...
export const IncreaseDecrease: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IncreaseDecreaseDimensions = {height: 24, width: 24}
