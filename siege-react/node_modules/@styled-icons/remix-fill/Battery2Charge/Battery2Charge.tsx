...
export const Battery2Charge: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Battery2ChargeDimensions = {height: 24, width: 24}
