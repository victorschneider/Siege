...
export const IndeterminateCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IndeterminateCircleDimensions = {height: 24, width: 24}
