...
export const ShoppingBasket2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShoppingBasket2Dimensions = {height: 24, width: 24}
