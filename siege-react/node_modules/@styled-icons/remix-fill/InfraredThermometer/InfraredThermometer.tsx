...
export const InfraredThermometer: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InfraredThermometerDimensions = {height: 24, width: 24}
