...
export const MoneyEuroCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MoneyEuroCircleDimensions = {height: 24, width: 24}
