...
export const MoneyPoundCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MoneyPoundCircleDimensions = {height: 24, width: 24}
