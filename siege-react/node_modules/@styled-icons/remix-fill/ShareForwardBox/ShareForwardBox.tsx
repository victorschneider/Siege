...
export const ShareForwardBox: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShareForwardBoxDimensions = {height: 24, width: 24}
