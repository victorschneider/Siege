...
export const Vector: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VectorDimensions = {height: 24, width: 24}
