...
export const LeftArrowSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LeftArrowSquareDimensions = {height: 24, width: 24}
