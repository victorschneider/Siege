...
export const PurchaseTagAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PurchaseTagAltDimensions = {height: 24, width: 24}
