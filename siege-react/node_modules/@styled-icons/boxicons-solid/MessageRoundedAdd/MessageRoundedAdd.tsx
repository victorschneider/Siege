...
export const MessageRoundedAdd: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageRoundedAddDimensions = {height: 24, width: 24}
