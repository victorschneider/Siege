...
export const CaretRightCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CaretRightCircleDimensions = {height: 24, width: 24}
