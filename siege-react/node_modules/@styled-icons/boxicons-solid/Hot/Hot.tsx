...
export const Hot: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HotDimensions = {height: 24, width: 24}
