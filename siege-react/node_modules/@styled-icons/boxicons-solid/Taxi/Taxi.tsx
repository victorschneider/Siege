...
export const Taxi: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TaxiDimensions = {height: 24, width: 24}
