...
export const MessageAltCheck: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageAltCheckDimensions = {height: 24, width: 24}
