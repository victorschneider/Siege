...
export const MessageAltError: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageAltErrorDimensions = {height: 24, width: 24}
