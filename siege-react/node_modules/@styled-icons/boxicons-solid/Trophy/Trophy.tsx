...
export const Trophy: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path fill="none" d="M18 6v6.83c1.784-.752 2-3.531 2-4.83V6h-2zM6 12.021V6H4v2c0 1.299.216 4.078 2 4.83v-.809z" />
...
export const TrophyDimensions = {height: 24, width: 24}
