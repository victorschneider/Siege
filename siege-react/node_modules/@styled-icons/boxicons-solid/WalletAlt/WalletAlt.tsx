...
export const WalletAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WalletAltDimensions = {height: 24, width: 24}
