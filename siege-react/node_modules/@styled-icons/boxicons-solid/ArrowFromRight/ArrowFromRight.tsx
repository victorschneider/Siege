...
export const ArrowFromRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowFromRightDimensions = {height: 24, width: 24}
