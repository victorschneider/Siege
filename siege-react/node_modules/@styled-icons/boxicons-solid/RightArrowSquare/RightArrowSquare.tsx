...
export const RightArrowSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RightArrowSquareDimensions = {height: 24, width: 24}
