...
export const MessageRoundedMinus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageRoundedMinusDimensions = {height: 24, width: 24}
