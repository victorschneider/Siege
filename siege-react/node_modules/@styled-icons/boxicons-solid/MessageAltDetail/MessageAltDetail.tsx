...
export const MessageAltDetail: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageAltDetailDimensions = {height: 24, width: 24}
