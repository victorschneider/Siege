...
export const VideoOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VideoOutlineDimensions = {height: 24, width: 24}
