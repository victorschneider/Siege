...
export const ArrowBackOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowBackOutlineDimensions = {height: 24, width: 24}
