...
export const EyeOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EyeOutlineDimensions = {height: 24, width: 24}
