...
export const SocialLinkedinCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialLinkedinCircularDimensions = {height: 24, width: 24}
