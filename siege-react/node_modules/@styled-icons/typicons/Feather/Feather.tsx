...
export const Feather: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FeatherDimensions = {height: 24, width: 24}
