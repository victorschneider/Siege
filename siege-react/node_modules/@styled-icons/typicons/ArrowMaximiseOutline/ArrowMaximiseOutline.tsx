...
export const ArrowMaximiseOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowMaximiseOutlineDimensions = {height: 24, width: 24}
