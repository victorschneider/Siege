...
export const CodeOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CodeOutlineDimensions = {height: 24, width: 24}
