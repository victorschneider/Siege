...
export const WeatherPartlySunny: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WeatherPartlySunnyDimensions = {height: 24, width: 24}
