...
export const ArrowLoopOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowLoopOutlineDimensions = {height: 24, width: 24}
