...
export const SocialGooglePlus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialGooglePlusDimensions = {height: 24, width: 24}
