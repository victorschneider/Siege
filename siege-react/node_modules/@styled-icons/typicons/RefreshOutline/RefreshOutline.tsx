...
export const RefreshOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RefreshOutlineDimensions = {height: 24, width: 24}
