...
export const StarHalfOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StarHalfOutlineDimensions = {height: 24, width: 24}
