...
export const StarFullOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StarFullOutlineDimensions = {height: 24, width: 24}
