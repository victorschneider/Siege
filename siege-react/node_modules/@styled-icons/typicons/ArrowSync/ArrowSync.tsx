...
export const ArrowSync: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowSyncDimensions = {height: 24, width: 24}
