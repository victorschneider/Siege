...
export const AdjustBrightness: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdjustBrightnessDimensions = {height: 24, width: 24}
