...
export const ArrowRepeatOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowRepeatOutlineDimensions = {height: 24, width: 24}
