...
export const ArrowMaximise: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowMaximiseDimensions = {height: 24, width: 24}
