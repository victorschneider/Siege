...
export const ArrowShuffle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowShuffleDimensions = {height: 24, width: 24}
