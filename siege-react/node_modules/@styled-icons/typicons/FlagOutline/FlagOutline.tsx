...
export const FlagOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FlagOutlineDimensions = {height: 24, width: 24}
