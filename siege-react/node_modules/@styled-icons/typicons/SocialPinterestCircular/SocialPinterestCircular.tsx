...
export const SocialPinterestCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialPinterestCircularDimensions = {height: 24, width: 24}
