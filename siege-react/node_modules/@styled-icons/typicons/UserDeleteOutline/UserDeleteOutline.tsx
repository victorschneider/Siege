...
export const UserDeleteOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UserDeleteOutlineDimensions = {height: 24, width: 24}
