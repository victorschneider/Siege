...
export const MediaPlayOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MediaPlayOutlineDimensions = {height: 24, width: 24}
