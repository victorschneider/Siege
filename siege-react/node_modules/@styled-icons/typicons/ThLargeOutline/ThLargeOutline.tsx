...
export const ThLargeOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ThLargeOutlineDimensions = {height: 24, width: 24}
