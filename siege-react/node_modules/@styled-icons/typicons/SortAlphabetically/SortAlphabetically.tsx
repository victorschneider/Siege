...
export const SortAlphabetically: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SortAlphabeticallyDimensions = {height: 24, width: 24}
