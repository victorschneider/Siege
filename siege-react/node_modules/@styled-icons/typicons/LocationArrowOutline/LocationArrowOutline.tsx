...
export const LocationArrowOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationArrowOutlineDimensions = {height: 24, width: 24}
