...
export const FlowParallel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FlowParallelDimensions = {height: 24, width: 24}
