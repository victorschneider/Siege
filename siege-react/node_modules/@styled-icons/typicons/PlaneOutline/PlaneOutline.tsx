...
export const PlaneOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlaneOutlineDimensions = {height: 24, width: 24}
