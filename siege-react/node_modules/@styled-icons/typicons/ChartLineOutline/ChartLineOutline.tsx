...
export const ChartLineOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChartLineOutlineDimensions = {height: 24, width: 24}
