...
export const CalendarOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CalendarOutlineDimensions = {height: 24, width: 24}
