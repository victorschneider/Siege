...
export const ArrowMinimiseOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowMinimiseOutlineDimensions = {height: 24, width: 24}
