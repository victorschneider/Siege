...
export const SocialGithubCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialGithubCircularDimensions = {height: 24, width: 24}
