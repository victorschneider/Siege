...
export const TimesOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TimesOutlineDimensions = {height: 24, width: 24}
