...
export const SocialFlickrCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialFlickrCircularDimensions = {height: 24, width: 24}
