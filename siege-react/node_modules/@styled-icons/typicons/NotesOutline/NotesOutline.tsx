...
export const NotesOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NotesOutlineDimensions = {height: 24, width: 24}
