...
export const SortNumerically: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SortNumericallyDimensions = {height: 24, width: 24}
