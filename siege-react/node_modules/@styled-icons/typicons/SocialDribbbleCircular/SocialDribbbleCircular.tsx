...
export const SocialDribbbleCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialDribbbleCircularDimensions = {height: 24, width: 24}
