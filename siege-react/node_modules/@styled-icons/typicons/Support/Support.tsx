...
export const Support: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SupportDimensions = {height: 24, width: 24}
