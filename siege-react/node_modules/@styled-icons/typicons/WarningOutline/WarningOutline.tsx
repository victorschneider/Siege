...
export const WarningOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WarningOutlineDimensions = {height: 24, width: 24}
