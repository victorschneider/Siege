...
export const SortNumericallyOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SortNumericallyOutlineDimensions = {height: 24, width: 24}
