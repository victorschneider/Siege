...
export const ArrowRepeat: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowRepeatDimensions = {height: 24, width: 24}
