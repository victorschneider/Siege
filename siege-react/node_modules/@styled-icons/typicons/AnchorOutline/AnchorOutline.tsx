...
export const AnchorOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AnchorOutlineDimensions = {height: 24, width: 24}
