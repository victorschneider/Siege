...
export const SocialTwitterCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialTwitterCircularDimensions = {height: 24, width: 24}
