...
export const HeartFullOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HeartFullOutlineDimensions = {height: 24, width: 24}
