...
export const Waves: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WavesDimensions = {height: 24, width: 24}
