...
export const SocialInstagramCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialInstagramCircularDimensions = {height: 24, width: 24}
