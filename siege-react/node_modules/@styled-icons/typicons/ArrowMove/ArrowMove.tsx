...
export const ArrowMove: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowMoveDimensions = {height: 24, width: 24}
