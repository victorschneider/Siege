...
export const SortAlphabeticallyOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SortAlphabeticallyOutlineDimensions = {height: 24, width: 24}
