...
export const SocialFacebookCircular: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocialFacebookCircularDimensions = {height: 24, width: 24}
