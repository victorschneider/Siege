...
export const UploadOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UploadOutlineDimensions = {height: 24, width: 24}
