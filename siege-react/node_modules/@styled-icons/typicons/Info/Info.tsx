...
export const Info: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InfoDimensions = {height: 24, width: 24}
