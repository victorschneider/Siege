...
export const ArrowMoveOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowMoveOutlineDimensions = {height: 24, width: 24}
