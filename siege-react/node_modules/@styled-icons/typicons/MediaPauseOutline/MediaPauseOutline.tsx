...
export const MediaPauseOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MediaPauseOutlineDimensions = {height: 24, width: 24}
