...
export const Chromecast: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChromecastDimensions = {height: 512, width: 512}
