...
export const AssistantPhoto: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AssistantPhotoDimensions = {height: 24, width: 24}
