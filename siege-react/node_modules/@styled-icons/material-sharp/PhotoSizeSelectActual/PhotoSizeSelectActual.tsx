...
export const PhotoSizeSelectActual: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhotoSizeSelectActualDimensions = {height: 24, width: 24}
