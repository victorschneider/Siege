...
export const MiscellaneousServices: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MiscellaneousServicesDimensions = {height: 24, width: 24}
