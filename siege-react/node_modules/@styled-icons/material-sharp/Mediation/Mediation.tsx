...
export const Mediation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MediationDimensions = {height: 24, width: 24}
