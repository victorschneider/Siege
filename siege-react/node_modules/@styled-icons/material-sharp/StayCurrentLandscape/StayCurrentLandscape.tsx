...
export const StayCurrentLandscape: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StayCurrentLandscapeDimensions = {height: 24, width: 24}
