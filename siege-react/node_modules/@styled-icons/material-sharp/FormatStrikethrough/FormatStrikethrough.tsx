...
export const FormatStrikethrough: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatStrikethroughDimensions = {height: 24, width: 24}
