...
export const FormatAlignCenter: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatAlignCenterDimensions = {height: 24, width: 24}
