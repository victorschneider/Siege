...
export const StopScreenShare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StopScreenShareDimensions = {height: 24, width: 24}
