...
export const FormatIndentIncrease: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatIndentIncreaseDimensions = {height: 24, width: 24}
