...
export const DirectionsBike: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DirectionsBikeDimensions = {height: 24, width: 24}
