...
export const PanoramaVertical: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PanoramaVerticalDimensions = {height: 24, width: 24}
