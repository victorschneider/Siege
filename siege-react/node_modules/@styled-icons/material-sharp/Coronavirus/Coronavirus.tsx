...
export const Coronavirus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CoronavirusDimensions = {height: 24, width: 24}
