...
export const FormatListBulleted: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatListBulletedDimensions = {height: 24, width: 24}
