...
export const AssignmentReturned: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AssignmentReturnedDimensions = {height: 24, width: 24}
