...
export const PhotoSizeSelectSmall: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhotoSizeSelectSmallDimensions = {height: 24, width: 24}
