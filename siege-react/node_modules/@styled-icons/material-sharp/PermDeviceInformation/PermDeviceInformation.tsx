...
export const PermDeviceInformation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PermDeviceInformationDimensions = {height: 24, width: 24}
