...
export const AssignmentLate: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AssignmentLateDimensions = {height: 24, width: 24}
