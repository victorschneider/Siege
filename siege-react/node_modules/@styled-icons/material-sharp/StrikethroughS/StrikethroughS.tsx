...
export const StrikethroughS: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StrikethroughSDimensions = {height: 24, width: 24}
