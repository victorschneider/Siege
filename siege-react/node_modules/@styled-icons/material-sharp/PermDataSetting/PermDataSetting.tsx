...
export const PermDataSetting: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PermDataSettingDimensions = {height: 24, width: 24}
