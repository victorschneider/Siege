...
export const FeaturedPlayList: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FeaturedPlayListDimensions = {height: 24, width: 24}
