...
export const BorderHorizontal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BorderHorizontalDimensions = {height: 24, width: 24}
