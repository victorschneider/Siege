...
export const KeyboardArrowUp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeyboardArrowUpDimensions = {height: 24, width: 24}
