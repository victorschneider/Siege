...
export const RemoveCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RemoveCircleOutlineDimensions = {height: 24, width: 24}
