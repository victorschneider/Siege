...
export const PestControlRodent: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PestControlRodentDimensions = {height: 24, width: 24}
