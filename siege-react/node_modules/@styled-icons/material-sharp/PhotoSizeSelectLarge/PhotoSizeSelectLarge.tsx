...
export const PhotoSizeSelectLarge: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhotoSizeSelectLargeDimensions = {height: 24, width: 24}
