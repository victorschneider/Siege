...
export const AlternateEmail: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AlternateEmailDimensions = {height: 24, width: 24}
