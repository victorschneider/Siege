...
export const WheelchairPickup: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WheelchairPickupDimensions = {height: 24, width: 24}
