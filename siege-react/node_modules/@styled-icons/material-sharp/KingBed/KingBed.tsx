...
export const KingBed: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={5} height={3} x={6} y={7} fill="none" />

      <rect width={5} height={3} x={13} y={7} fill="none" />
...
export const KingBedDimensions = {height: 24, width: 24}
