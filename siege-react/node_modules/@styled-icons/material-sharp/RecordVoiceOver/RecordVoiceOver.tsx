...
export const RecordVoiceOver: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RecordVoiceOverDimensions = {height: 24, width: 24}
