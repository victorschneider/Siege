...
export const MedicalServices: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MedicalServicesDimensions = {height: 24, width: 24}
