...
export const KeyboardCapslock: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeyboardCapslockDimensions = {height: 24, width: 24}
