...
export const DiagonalArrowLeftUp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DiagonalArrowLeftUpDimensions = {height: 24, width: 24}
