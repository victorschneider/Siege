...
export const CheckmarkSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckmarkSquareDimensions = {height: 24, width: 24}
