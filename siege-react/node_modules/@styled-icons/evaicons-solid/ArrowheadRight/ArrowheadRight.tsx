...
export const ArrowheadRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowheadRightDimensions = {height: 24, width: 24}
