...
export const ArrowLeftRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowLeftRightDimensions = {height: 24, width: 24}
