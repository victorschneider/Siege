...
export const VoiceRecognition: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VoiceRecognitionDimensions = {height: 24, width: 24}
