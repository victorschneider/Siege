...
export const FolderReceived: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderReceivedDimensions = {height: 24, width: 24}
