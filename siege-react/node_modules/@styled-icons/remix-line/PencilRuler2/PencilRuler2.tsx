...
export const PencilRuler2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PencilRuler2Dimensions = {height: 24, width: 24}
