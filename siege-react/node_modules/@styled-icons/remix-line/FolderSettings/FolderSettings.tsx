...
export const FolderSettings: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderSettingsDimensions = {height: 24, width: 24}
