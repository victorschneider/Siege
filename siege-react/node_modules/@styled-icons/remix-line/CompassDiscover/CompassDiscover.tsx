...
export const CompassDiscover: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CompassDiscoverDimensions = {height: 24, width: 24}
