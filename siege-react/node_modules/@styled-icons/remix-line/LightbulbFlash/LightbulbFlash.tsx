...
export const LightbulbFlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LightbulbFlashDimensions = {height: 24, width: 24}
