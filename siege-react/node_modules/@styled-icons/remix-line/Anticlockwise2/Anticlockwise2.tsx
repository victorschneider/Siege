...
export const Anticlockwise2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Anticlockwise2Dimensions = {height: 24, width: 24}
