...
export const Settings5: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Settings5Dimensions = {height: 24, width: 24}
