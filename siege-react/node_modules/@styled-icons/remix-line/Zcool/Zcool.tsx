...
export const Zcool: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZcoolDimensions = {height: 24, width: 24}
