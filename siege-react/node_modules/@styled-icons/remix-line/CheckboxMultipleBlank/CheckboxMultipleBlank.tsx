...
export const CheckboxMultipleBlank: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckboxMultipleBlankDimensions = {height: 24, width: 24}
