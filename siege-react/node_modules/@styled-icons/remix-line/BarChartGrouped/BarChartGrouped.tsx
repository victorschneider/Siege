...
export const BarChartGrouped: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BarChartGroupedDimensions = {height: 24, width: 24}
