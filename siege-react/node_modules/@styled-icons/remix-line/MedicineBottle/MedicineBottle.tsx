...
export const MedicineBottle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MedicineBottleDimensions = {height: 24, width: 24}
