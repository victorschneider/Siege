...
export const MoneyCnyCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MoneyCnyCircleDimensions = {height: 24, width: 24}
