...
export const NotificationBadge: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NotificationBadgeDimensions = {height: 24, width: 24}
