...
export const Vimeo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VimeoDimensions = {height: 24, width: 24}
