...
export const Wechat: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WechatDimensions = {height: 24, width: 24}
