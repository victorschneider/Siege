...
export const CharacterRecognition: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CharacterRecognitionDimensions = {height: 24, width: 24}
