...
export const TerminalWindow: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TerminalWindowDimensions = {height: 24, width: 24}
