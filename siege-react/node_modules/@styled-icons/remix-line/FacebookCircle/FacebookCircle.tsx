...
export const FacebookCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FacebookCircleDimensions = {height: 24, width: 24}
