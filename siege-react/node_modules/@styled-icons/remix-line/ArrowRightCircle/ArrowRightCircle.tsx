...
export const ArrowRightCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowRightCircleDimensions = {height: 24, width: 24}
