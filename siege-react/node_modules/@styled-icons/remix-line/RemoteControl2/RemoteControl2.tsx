...
export const RemoteControl2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RemoteControl2Dimensions = {height: 24, width: 24}
