...
export const FolderDownload: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderDownloadDimensions = {height: 24, width: 24}
