...
export const SkipForwardMini: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SkipForwardMiniDimensions = {height: 24, width: 24}
