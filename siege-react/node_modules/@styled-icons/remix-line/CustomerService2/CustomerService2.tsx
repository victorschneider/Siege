...
export const CustomerService2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CustomerService2Dimensions = {height: 24, width: 24}
