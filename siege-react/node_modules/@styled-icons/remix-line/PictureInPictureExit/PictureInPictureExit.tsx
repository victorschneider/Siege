...
export const PictureInPictureExit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PictureInPictureExitDimensions = {height: 24, width: 24}
