...
export const ArrowDropRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowDropRightDimensions = {height: 24, width: 24}
