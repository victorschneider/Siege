...
export const CheckboxCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckboxCircleDimensions = {height: 24, width: 24}
