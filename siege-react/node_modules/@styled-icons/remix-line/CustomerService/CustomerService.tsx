...
export const CustomerService: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CustomerServiceDimensions = {height: 24, width: 24}
