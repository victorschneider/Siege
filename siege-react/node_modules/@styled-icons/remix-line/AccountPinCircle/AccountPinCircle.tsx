...
export const AccountPinCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AccountPinCircleDimensions = {height: 24, width: 24}
