...
export const FolderTransfer: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderTransferDimensions = {height: 24, width: 24}
