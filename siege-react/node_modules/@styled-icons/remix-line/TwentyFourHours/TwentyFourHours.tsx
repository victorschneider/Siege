...
export const TwentyFourHours: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TwentyFourHoursDimensions = {height: 24, width: 24}
