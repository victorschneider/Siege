...
export const Footprint: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FootprintDimensions = {height: 24, width: 24}
