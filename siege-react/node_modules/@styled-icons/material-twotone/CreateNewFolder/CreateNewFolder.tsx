...
export const CreateNewFolder: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreateNewFolderDimensions = {height: 24, width: 24}
