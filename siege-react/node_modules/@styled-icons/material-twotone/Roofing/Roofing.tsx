...
export const Roofing: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={2} height={2} x={11} y={16} opacity={.3} />
...
export const RoofingDimensions = {height: 24, width: 24}
