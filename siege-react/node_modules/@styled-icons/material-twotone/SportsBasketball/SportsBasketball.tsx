...
export const SportsBasketball: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SportsBasketballDimensions = {height: 24, width: 24}
