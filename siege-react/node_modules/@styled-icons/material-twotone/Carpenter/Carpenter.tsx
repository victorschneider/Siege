...
export const Carpenter: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M5.71 5.62L7 4.33l8.49 8.49-2.81 2.81L5.71 5.62z" opacity={.3} />
...
export const CarpenterDimensions = {height: 24, width: 24}
