...
export const FollowTheSigns: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M17.64 7.75V6h-3.51V4.5h3.51V2.75l2.49 2.5-2.49 2.5z" opacity={.3} />
...
export const FollowTheSignsDimensions = {height: 24, width: 24}
