...
export const MilitaryTech: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <polygon points="13,11.07 15,9.87 15,4 13,4" opacity={.3} />

      <polygon points="9,4 9,9.87 11,11.07 11,4" opacity={.3} />
...
export const MilitaryTechDimensions = {height: 24, width: 24}
