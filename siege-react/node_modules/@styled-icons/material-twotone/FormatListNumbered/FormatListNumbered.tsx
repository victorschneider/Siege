...
export const FormatListNumbered: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatListNumberedDimensions = {height: 24, width: 24}
