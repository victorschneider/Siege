...
export const SignalWifi4Bar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SignalWifi4BarDimensions = {height: 24, width: 24}
