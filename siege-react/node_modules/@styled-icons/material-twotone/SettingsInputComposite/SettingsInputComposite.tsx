...
export const SettingsInputComposite: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsInputCompositeDimensions = {height: 24, width: 24}
