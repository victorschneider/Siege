...
export const Pool: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <circle cx={16.5} cy={5.5} r={2.5} opacity={.3} />
...
export const PoolDimensions = {height: 24, width: 24}
