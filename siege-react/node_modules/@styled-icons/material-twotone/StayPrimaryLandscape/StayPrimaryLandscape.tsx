...
export const StayPrimaryLandscape: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StayPrimaryLandscapeDimensions = {height: 24, width: 24}
