...
export const FamilyRestroom: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FamilyRestroomDimensions = {height: 24, width: 24}
