...
export const InsertEmoticon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InsertEmoticonDimensions = {height: 24, width: 24}
