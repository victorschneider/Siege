...
export const EmojiObjects: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={4} height={1} x={10} y={18} opacity={.3} />

      <rect width={4} height={1} x={10} y={16} opacity={.3} />
      ...
      <g>
  <rect width={1} height={3} x={11.5} y={11} />
  <rect width={1} height={3} x={10.59} y={8.79} transform="rotate(-45.001 11.086 10.293)" />
  <rect width={1} height={3} x={12.41} y={8.79} transform="rotate(-134.999 12.914 10.293)" />
</g>
...
export const EmojiObjectsDimensions = {height: 24, width: 24}
