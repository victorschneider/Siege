...
export const MoveToInbox: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M12.01 18c-1.48 0-2.75-.81-3.45-2H5v3h14v-3h-3.55a3.98 3.98 0 01-3.44 2z" opacity={.3} />
...
export const MoveToInboxDimensions = {height: 24, width: 24}
