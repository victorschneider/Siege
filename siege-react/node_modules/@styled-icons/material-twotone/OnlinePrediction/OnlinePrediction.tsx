...
export const OnlinePrediction: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OnlinePredictionDimensions = {height: 24, width: 24}
