...
export const SentimentVeryDissatisfied: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SentimentVeryDissatisfiedDimensions = {height: 24, width: 24}
