...
export const VisibilityOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VisibilityOffDimensions = {height: 24, width: 24}
