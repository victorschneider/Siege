...
export const BusinessCenter: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BusinessCenterDimensions = {height: 24, width: 24}
