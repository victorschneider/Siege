...
export const PersonPinCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PersonPinCircleDimensions = {height: 24, width: 24}
