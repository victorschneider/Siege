...
export const HorizontalSplit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HorizontalSplitDimensions = {height: 24, width: 24}
