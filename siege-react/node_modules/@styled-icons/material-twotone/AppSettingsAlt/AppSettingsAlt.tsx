...
export const AppSettingsAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={10} height={1} x={7} y={20} fill="none" />

      <rect width={10} height={1} x={7} y={3} fill="none" />
      ...
      <rect width={10} height={1} x={7} y={3} opacity={.3} />

      <rect width={10} height={1} x={7} y={20} opacity={.3} />
...
export const AppSettingsAltDimensions = {height: 24, width: 24}
