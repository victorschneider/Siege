...
export const Handyman: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <polygon points="8.66,14.64 4.41,18.88 5.12,19.59 9.36,15.34 9.36,15.34 8.66,14.64" opacity={.3} />

      <rect width={1} height={6} x={16.57} y={14.11} opacity={.3} transform="rotate(-45.001 17.074 17.111)" />
