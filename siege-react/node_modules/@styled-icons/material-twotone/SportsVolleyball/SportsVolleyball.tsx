...
export const SportsVolleyball: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SportsVolleyballDimensions = {height: 24, width: 24}
