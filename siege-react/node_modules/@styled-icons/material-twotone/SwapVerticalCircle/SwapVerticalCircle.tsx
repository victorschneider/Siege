...
export const SwapVerticalCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SwapVerticalCircleDimensions = {height: 24, width: 24}
