...
export const PersonAddAlt1: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M9 16c-2.7 0-5.8 1.29-6 2h12c-.22-.72-3.31-2-6-2z" opacity={.3} />

      <path d="M9 14c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm-6 4c.2-.71 3.3-2 6-2 2.69 0 5.78 1.28 6 2H3z" />
...
export const PersonAddAlt1Dimensions = {height: 24, width: 24}
