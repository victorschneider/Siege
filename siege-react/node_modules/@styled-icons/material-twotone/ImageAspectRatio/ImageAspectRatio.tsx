...
export const ImageAspectRatio: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ImageAspectRatioDimensions = {height: 24, width: 24}
