...
export const EditLocation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M14.11 14H8V7.91l.59-.59L11.91 4C8.61 4.05 6 6.6 6 10.2c0 2.34 1.95 5.44 6 9.14 4.05-3.7 6-6.79 6-9.14v-.08l-3.3 3.3-.59.58z" opacity={.3} />
      ...
      <polygon points="18.17,4.91 17.1,3.84 11.55,9.39 11.55,10.47 12.63,10.47" opacity={.3} />
...
export const EditLocationDimensions = {height: 24, width: 24}
