...
export const SubtitlesOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <polygon points="8.83,6 12.83,10 18,10 18,12 14.83,12 20,17.17 20,6" opacity={.3} />

      <polygon points="15.17,18 13.17,16 6,16 6,14 11.17,14 8,10.83 8,12 6,12 6,10 7.17,10 4,6.83 4,18" opacity={.3} />
...
export const SubtitlesOffDimensions = {height: 24, width: 24}
