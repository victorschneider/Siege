...
export const InvertColors: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M6 13.59c0 1.6.62 3.1 1.76 4.24A5.928 5.928 0 0012 19.59V5.1L7.76 9.35A5.928 5.928 0 006 13.59z" opacity={.3} />
...
export const InvertColorsDimensions = {height: 24, width: 24}
