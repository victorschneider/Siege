...
export const AddCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AddCircleOutlineDimensions = {height: 24, width: 24}
