...
export const OfficeBuilding: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OfficeBuildingDimensions = {height: 20, width: 20}
