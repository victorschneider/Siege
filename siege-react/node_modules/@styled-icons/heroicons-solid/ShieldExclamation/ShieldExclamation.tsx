...
export const ShieldExclamation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShieldExclamationDimensions = {height: 20, width: 20}
