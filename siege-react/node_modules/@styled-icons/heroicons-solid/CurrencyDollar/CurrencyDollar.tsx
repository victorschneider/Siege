...
export const CurrencyDollar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CurrencyDollarDimensions = {height: 20, width: 20}
