...
export const ArrowNarrowRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowNarrowRightDimensions = {height: 20, width: 20}
