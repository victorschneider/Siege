...
export const SwitchHorizontal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SwitchHorizontalDimensions = {height: 20, width: 20}
