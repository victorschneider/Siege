...
export const RemoveCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <line x1={336} x2={176} y1={256} y2={256} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} />
...
export const RemoveCircleDimensions = {height: 512, width: 512}
