...
export const Browsers: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <rect width={416} height={384} x={48} y={64} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={32} rx={48} ry={48} />
...
export const BrowsersDimensions = {height: 512, width: 512}
