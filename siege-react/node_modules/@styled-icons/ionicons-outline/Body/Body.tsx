...
export const Body: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <circle cx={248} cy={56} r={40} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={32} />
...
export const BodyDimensions = {height: 512, width: 512}
