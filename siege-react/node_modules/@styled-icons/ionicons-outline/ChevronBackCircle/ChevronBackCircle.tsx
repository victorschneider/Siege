...
export const ChevronBackCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <polyline fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} points="296 352 200 256 296 160" />
...
export const ChevronBackCircleDimensions = {height: 512, width: 512}
