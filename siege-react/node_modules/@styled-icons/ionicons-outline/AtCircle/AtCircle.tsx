...
export const AtCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={32} d="M448.08 256.08c0-106-86-192-192-192s-192 86-192 192 86 192 192 192 192-85.97 192-192z" />
...
export const AtCircleDimensions = {height: 512, width: 512}
