...
export const Earth: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={32} d="M464 256c0-114.87-93.13-208-208-208S48 141.13 48 256s93.13 208 208 208 208-93.13 208-208z" />
...
export const EarthDimensions = {height: 512, width: 512}
