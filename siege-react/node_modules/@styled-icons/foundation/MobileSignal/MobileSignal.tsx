...
export const MobileSignal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path d="M69.328 29.884H30.567v.01a2.495 2.495 0 00-2.396 2.49v59.967a2.495 2.495 0 002.396 2.489v.011h38.761a2.5 2.5 0 002.5-2.5V32.384a2.5 2.5 0 00-2.5-2.5zM50.059 92.268a2.45 2.45 0 110-4.9 2.45 2.45 0 010 4.9zm11.813-7.396H38.128V39.84h23.743v45.032z" />
...
export const MobileSignalDimensions = {height: 100, width: 100}
