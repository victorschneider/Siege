...
export const SheriffBadge: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SheriffBadgeDimensions = {height: 100, width: 100}
