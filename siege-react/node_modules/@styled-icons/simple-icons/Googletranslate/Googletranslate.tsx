...
export const Googletranslate: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GoogletranslateDimensions = {height: 24, width: 24}
