...
export const Mozillathunderbird: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MozillathunderbirdDimensions = {height: 24, width: 24}
