...
export const Googleclassroom: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GoogleclassroomDimensions = {height: 24, width: 24}
