...
export const Neo4j: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Neo4jDimensions = {height: 24, width: 24}
