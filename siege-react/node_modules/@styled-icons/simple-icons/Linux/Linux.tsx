...
export const Linux: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LinuxDimensions = {height: 24, width: 24}
