...
export const Webrtc: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WebrtcDimensions = {height: 24, width: 24}
