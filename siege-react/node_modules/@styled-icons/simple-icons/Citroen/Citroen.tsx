...
export const Citroen: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CitroenDimensions = {height: 24, width: 24}
