...
export const Themoviedatabase: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ThemoviedatabaseDimensions = {height: 24, width: 24}
