...
export const Lgtm: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LgtmDimensions = {height: 24, width: 24}
