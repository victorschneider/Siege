...
export const Letsencrypt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LetsencryptDimensions = {height: 24, width: 24}
