...
export const Googleanalytics: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GoogleanalyticsDimensions = {height: 24, width: 24}
