...
export const Adobelightroomcc: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobelightroomccDimensions = {height: 24, width: 24}
