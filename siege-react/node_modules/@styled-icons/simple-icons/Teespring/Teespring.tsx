...
export const Teespring: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TeespringDimensions = {height: 24, width: 24}
