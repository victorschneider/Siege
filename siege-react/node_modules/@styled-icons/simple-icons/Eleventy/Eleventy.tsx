...
export const Eleventy: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EleventyDimensions = {height: 24, width: 24}
