...
export const SocketDotIo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SocketDotIoDimensions = {height: 24, width: 24}
