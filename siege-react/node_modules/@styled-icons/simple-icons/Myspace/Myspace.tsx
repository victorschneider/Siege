...
export const Myspace: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MyspaceDimensions = {height: 24, width: 24}
