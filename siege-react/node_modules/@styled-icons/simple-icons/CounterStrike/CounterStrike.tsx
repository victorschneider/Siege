...
export const CounterStrike: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CounterStrikeDimensions = {height: 24, width: 24}
