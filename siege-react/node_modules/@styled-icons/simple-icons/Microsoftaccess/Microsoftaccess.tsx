...
export const Microsoftaccess: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftaccessDimensions = {height: 24, width: 24}
