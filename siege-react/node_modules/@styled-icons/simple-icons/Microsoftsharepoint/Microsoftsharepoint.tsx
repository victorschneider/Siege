...
export const Microsoftsharepoint: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftsharepointDimensions = {height: 24, width: 24}
