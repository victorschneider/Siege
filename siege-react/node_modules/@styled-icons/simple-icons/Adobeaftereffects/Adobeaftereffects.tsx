...
export const Adobeaftereffects: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobeaftereffectsDimensions = {height: 24, width: 24}
