...
export const Veritas: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VeritasDimensions = {height: 24, width: 24}
