...
export const Mozillafirefox: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MozillafirefoxDimensions = {height: 24, width: 24}
