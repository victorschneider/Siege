...
export const Googlenews: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglenewsDimensions = {height: 24, width: 24}
