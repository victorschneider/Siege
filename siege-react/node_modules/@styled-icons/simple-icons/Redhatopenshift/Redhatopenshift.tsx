...
export const Redhatopenshift: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RedhatopenshiftDimensions = {height: 24, width: 24}
