...
export const Justeat: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const JusteatDimensions = {height: 24, width: 24}
