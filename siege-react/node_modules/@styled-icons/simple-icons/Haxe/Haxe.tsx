...
export const Haxe: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HaxeDimensions = {height: 24, width: 24}
