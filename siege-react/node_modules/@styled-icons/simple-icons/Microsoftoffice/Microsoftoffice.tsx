...
export const Microsoftoffice: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftofficeDimensions = {height: 24, width: 24}
