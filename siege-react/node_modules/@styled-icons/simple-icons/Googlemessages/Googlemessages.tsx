...
export const Googlemessages: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglemessagesDimensions = {height: 24, width: 24}
