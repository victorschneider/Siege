...
export const Yamahacorporation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const YamahacorporationDimensions = {height: 24, width: 24}
