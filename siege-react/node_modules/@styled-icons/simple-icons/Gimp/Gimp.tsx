...
export const Gimp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GimpDimensions = {height: 24, width: 24}
