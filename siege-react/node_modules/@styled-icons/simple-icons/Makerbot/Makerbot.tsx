...
export const Makerbot: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MakerbotDimensions = {height: 24, width: 24}
