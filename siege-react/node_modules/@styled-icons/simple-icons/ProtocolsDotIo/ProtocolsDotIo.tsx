...
export const ProtocolsDotIo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ProtocolsDotIoDimensions = {height: 24, width: 24}
