...
export const Adobephotoshop: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobephotoshopDimensions = {height: 24, width: 24}
