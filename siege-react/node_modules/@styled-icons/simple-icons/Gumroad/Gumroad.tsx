...
export const Gumroad: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GumroadDimensions = {height: 24, width: 24}
