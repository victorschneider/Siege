...
export const Googlesearchconsole: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglesearchconsoleDimensions = {height: 24, width: 24}
