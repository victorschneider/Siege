...
export const Matrix: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MatrixDimensions = {height: 24, width: 24}
