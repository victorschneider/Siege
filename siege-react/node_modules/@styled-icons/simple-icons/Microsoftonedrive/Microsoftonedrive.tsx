...
export const Microsoftonedrive: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftonedriveDimensions = {height: 24, width: 24}
