...
export const Zingat: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZingatDimensions = {height: 24, width: 24}
