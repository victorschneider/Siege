...
export const Microsoftvisio: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftvisioDimensions = {height: 24, width: 24}
