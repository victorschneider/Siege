...
export const Eclipsemosquitto: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EclipsemosquittoDimensions = {height: 24, width: 24}
