...
export const Authy: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AuthyDimensions = {height: 24, width: 24}
