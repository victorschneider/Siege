...
export const Runkeeper: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RunkeeperDimensions = {height: 24, width: 24}
