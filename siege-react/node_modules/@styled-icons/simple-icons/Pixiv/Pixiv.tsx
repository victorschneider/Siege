...
export const Pixiv: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PixivDimensions = {height: 24, width: 24}
