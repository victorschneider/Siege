...
export const Affinitydesigner: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AffinitydesignerDimensions = {height: 24, width: 24}
