...
export const Archiveofourown: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArchiveofourownDimensions = {height: 24, width: 24}
