...
export const Solus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SolusDimensions = {height: 24, width: 24}
