...
export const Quasar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuasarDimensions = {height: 24, width: 24}
