...
export const Evry: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EvryDimensions = {height: 24, width: 24}
