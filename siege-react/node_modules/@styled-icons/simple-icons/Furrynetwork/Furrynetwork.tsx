...
export const Furrynetwork: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FurrynetworkDimensions = {height: 24, width: 24}
