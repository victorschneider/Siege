...
export const Stubhub: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StubhubDimensions = {height: 24, width: 24}
