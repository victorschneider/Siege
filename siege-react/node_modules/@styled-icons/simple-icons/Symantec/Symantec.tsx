...
export const Symantec: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SymantecDimensions = {height: 24, width: 24}
