...
export const Electron: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ElectronDimensions = {height: 24, width: 24}
