...
export const Goodreads: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GoodreadsDimensions = {height: 24, width: 24}
