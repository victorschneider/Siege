...
export const Hackster: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HacksterDimensions = {height: 24, width: 24}
