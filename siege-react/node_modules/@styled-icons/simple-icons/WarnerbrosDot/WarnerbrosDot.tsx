...
export const WarnerbrosDot: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WarnerbrosDotDimensions = {height: 24, width: 24}
