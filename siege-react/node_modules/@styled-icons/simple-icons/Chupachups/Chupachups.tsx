...
export const Chupachups: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChupachupsDimensions = {height: 24, width: 24}
