...
export const Sourceengine: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SourceengineDimensions = {height: 24, width: 24}
