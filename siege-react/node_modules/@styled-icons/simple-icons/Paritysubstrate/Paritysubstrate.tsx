...
export const Paritysubstrate: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ParitysubstrateDimensions = {height: 24, width: 24}
