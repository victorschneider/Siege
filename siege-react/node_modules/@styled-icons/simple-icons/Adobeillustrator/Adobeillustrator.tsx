...
export const Adobeillustrator: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobeillustratorDimensions = {height: 24, width: 24}
