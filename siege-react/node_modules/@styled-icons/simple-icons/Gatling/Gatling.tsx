...
export const Gatling: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GatlingDimensions = {height: 24, width: 24}
