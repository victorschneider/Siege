...
export const Googlestreetview: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglestreetviewDimensions = {height: 24, width: 24}
