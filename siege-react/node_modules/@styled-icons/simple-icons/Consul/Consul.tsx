...
export const Consul: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ConsulDimensions = {height: 24, width: 24}
