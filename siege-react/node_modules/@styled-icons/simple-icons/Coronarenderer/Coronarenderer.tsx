...
export const Coronarenderer: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CoronarendererDimensions = {height: 24, width: 24}
