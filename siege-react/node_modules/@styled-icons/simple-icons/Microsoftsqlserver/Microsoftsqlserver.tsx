...
export const Microsoftsqlserver: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftsqlserverDimensions = {height: 24, width: 24}
