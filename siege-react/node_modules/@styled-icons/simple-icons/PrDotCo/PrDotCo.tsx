...
export const PrDotCo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PrDotCoDimensions = {height: 24, width: 24}
