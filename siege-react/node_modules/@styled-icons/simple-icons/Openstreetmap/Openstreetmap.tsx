...
export const Openstreetmap: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OpenstreetmapDimensions = {height: 24, width: 24}
