...
export const Angellist: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AngellistDimensions = {height: 24, width: 24}
