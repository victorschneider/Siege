...
export const Landrover: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LandroverDimensions = {height: 24, width: 24}
