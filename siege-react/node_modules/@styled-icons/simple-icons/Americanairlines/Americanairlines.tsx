...
export const Americanairlines: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AmericanairlinesDimensions = {height: 24, width: 24}
