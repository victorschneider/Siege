...
export const Nintendoswitch: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NintendoswitchDimensions = {height: 24, width: 24}
