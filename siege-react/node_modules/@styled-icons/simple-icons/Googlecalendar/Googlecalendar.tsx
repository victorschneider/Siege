...
export const Googlecalendar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglecalendarDimensions = {height: 24, width: 24}
