...
export const Mini: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MiniDimensions = {height: 24, width: 24}
