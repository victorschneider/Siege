...
export const Apache: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApacheDimensions = {height: 24, width: 24}
