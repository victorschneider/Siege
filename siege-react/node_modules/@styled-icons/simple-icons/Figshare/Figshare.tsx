...
export const Figshare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FigshareDimensions = {height: 24, width: 24}
