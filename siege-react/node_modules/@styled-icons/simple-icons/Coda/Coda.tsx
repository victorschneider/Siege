...
export const Coda: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CodaDimensions = {height: 24, width: 24}
