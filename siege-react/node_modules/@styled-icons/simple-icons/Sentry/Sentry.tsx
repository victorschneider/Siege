...
export const Sentry: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SentryDimensions = {height: 24, width: 24}
