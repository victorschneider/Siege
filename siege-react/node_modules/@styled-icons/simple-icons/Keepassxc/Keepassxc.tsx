...
export const Keepassxc: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeepassxcDimensions = {height: 24, width: 24}
