...
export const Skoda: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SkodaDimensions = {height: 24, width: 24}
