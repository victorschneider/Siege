...
export const Fluentd: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FluentdDimensions = {height: 24, width: 24}
