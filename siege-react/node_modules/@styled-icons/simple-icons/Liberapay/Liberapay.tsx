...
export const Liberapay: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LiberapayDimensions = {height: 24, width: 24}
