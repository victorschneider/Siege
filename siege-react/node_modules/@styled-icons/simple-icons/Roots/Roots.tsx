...
export const Roots: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RootsDimensions = {height: 24, width: 24}
