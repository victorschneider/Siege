...
export const Contactlesspayment: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ContactlesspaymentDimensions = {height: 24, width: 24}
