...
export const Apple: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AppleDimensions = {height: 24, width: 24}
