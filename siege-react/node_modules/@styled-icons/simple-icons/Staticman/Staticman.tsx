...
export const Staticman: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StaticmanDimensions = {height: 24, width: 24}
