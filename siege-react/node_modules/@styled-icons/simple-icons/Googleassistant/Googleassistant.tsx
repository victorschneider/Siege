...
export const Googleassistant: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GoogleassistantDimensions = {height: 24, width: 24}
