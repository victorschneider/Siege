...
export const Apacheopenoffice: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApacheopenofficeDimensions = {height: 24, width: 24}
