...
export const Playstation3: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Playstation3Dimensions = {height: 24, width: 24}
