...
export const Radiopublic: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RadiopublicDimensions = {height: 24, width: 24}
