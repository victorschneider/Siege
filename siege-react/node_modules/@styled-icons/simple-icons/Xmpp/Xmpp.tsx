...
export const Xmpp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const XmppDimensions = {height: 24, width: 24}
