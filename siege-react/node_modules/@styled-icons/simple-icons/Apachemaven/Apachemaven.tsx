...
export const Apachemaven: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApachemavenDimensions = {height: 24, width: 24}
