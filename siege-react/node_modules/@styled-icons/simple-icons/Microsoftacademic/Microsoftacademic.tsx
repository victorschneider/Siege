...
export const Microsoftacademic: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftacademicDimensions = {height: 24, width: 24}
