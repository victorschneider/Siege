...
export const Googlepodcasts: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglepodcastsDimensions = {height: 24, width: 24}
