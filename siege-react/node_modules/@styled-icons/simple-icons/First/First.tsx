...
export const First: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FirstDimensions = {height: 24, width: 24}
