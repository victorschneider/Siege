...
export const Gnusocial: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GnusocialDimensions = {height: 24, width: 24}
