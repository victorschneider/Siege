...
export const Jenkinsx: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const JenkinsxDimensions = {height: 24, width: 24}
