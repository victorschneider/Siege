...
export const Microsoftonenote: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftonenoteDimensions = {height: 24, width: 24}
