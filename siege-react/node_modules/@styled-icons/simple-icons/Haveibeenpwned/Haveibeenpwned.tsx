...
export const Haveibeenpwned: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HaveibeenpwnedDimensions = {height: 24, width: 24}
