...
export const Materialdesignicons: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MaterialdesigniconsDimensions = {height: 24, width: 24}
