...
export const Apacheecharts: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApacheechartsDimensions = {height: 24, width: 24}
