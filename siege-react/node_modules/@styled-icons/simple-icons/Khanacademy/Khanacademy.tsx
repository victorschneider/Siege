...
export const Khanacademy: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KhanacademyDimensions = {height: 24, width: 24}
