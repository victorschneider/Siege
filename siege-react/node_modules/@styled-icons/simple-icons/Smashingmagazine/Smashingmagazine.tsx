...
export const Smashingmagazine: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SmashingmagazineDimensions = {height: 24, width: 24}
