...
export const Smart: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SmartDimensions = {height: 24, width: 24}
