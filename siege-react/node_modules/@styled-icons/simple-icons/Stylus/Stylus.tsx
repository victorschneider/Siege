...
export const Stylus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StylusDimensions = {height: 24, width: 24}
