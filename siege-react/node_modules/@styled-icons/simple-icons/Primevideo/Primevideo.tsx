...
export const Primevideo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PrimevideoDimensions = {height: 24, width: 24}
