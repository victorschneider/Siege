...
export const Gnuemacs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GnuemacsDimensions = {height: 24, width: 24}
