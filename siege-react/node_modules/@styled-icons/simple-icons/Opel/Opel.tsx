...
export const Opel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OpelDimensions = {height: 24, width: 24}
