...
export const Worldhealthorganization: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WorldhealthorganizationDimensions = {height: 24, width: 24}
