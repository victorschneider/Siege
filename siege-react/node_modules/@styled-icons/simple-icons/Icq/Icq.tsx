...
export const Icq: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IcqDimensions = {height: 24, width: 24}
