...
export const Weasyl: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WeasylDimensions = {height: 24, width: 24}
