...
export const Playstationvita: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlaystationvitaDimensions = {height: 24, width: 24}
