...
export const Openapiinitiative: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OpenapiinitiativeDimensions = {height: 24, width: 24}
