...
export const WebcomponentsDotOrg: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WebcomponentsDotOrgDimensions = {height: 24, width: 24}
