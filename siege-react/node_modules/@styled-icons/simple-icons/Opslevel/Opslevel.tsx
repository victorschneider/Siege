...
export const Opslevel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OpslevelDimensions = {height: 24, width: 24}
