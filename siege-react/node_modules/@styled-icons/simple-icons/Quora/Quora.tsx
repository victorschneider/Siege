...
export const Quora: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuoraDimensions = {height: 24, width: 24}
