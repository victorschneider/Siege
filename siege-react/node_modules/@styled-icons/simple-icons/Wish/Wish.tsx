...
export const Wish: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WishDimensions = {height: 24, width: 24}
