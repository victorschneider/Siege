...
export const Affinitypublisher: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AffinitypublisherDimensions = {height: 24, width: 24}
