...
export const Showpad: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShowpadDimensions = {height: 24, width: 24}
