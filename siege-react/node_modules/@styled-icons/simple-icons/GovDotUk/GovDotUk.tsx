...
export const GovDotUk: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GovDotUkDimensions = {height: 24, width: 24}
