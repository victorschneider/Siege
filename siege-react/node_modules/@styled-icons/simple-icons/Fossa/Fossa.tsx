...
export const Fossa: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FossaDimensions = {height: 24, width: 24}
