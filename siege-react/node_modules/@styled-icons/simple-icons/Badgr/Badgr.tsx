...
export const Badgr: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BadgrDimensions = {height: 24, width: 24}
