...
export const Hootsuite: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HootsuiteDimensions = {height: 24, width: 24}
