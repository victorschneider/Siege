...
export const Microsoftexcel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftexcelDimensions = {height: 24, width: 24}
