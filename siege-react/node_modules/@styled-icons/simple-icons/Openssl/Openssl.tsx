...
export const Openssl: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OpensslDimensions = {height: 24, width: 24}
