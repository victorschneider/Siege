...
export const Transportforireland: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TransportforirelandDimensions = {height: 24, width: 24}
