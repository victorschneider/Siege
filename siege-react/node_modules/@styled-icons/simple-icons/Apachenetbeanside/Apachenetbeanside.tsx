...
export const Apachenetbeanside: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApachenetbeansideDimensions = {height: 24, width: 24}
