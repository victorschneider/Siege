...
export const Playerfm: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlayerfmDimensions = {height: 24, width: 24}
