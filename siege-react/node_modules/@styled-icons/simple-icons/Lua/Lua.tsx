...
export const Lua: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LuaDimensions = {height: 24, width: 24}
