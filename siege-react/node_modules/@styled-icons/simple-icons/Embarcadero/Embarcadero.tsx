...
export const Embarcadero: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EmbarcaderoDimensions = {height: 24, width: 24}
