...
export const Appletv: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AppletvDimensions = {height: 24, width: 24}
