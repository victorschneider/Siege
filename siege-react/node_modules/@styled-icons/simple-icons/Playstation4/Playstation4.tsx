...
export const Playstation4: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Playstation4Dimensions = {height: 24, width: 24}
