...
export const Johndeere: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const JohndeereDimensions = {height: 24, width: 24}
