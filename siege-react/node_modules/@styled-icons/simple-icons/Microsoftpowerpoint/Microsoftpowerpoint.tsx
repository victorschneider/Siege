...
export const Microsoftpowerpoint: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftpowerpointDimensions = {height: 24, width: 24}
