...
export const Splunk: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SplunkDimensions = {height: 24, width: 24}
