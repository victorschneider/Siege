...
export const Facebooklive: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FacebookliveDimensions = {height: 24, width: 24}
