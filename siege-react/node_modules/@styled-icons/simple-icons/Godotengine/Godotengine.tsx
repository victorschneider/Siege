...
export const Godotengine: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GodotengineDimensions = {height: 24, width: 24}
