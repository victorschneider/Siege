...
export const Mariadbfoundation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MariadbfoundationDimensions = {height: 24, width: 24}
