...
export const Microsoftexchange: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftexchangeDimensions = {height: 24, width: 24}
