...
export const ItchDotIo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ItchDotIoDimensions = {height: 24, width: 24}
