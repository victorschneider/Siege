...
export const Lamborghini: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LamborghiniDimensions = {height: 24, width: 24}
