...
export const Adobefonts: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobefontsDimensions = {height: 24, width: 24}
