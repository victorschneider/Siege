...
export const Googlecardboard: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglecardboardDimensions = {height: 24, width: 24}
