...
export const Discogs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DiscogsDimensions = {height: 24, width: 24}
