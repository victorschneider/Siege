...
export const Wprocket: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WprocketDimensions = {height: 24, width: 24}
