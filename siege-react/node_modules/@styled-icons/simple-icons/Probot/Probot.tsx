...
export const Probot: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ProbotDimensions = {height: 24, width: 24}
