...
export const Codacy: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CodacyDimensions = {height: 24, width: 24}
