...
export const Ansys: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AnsysDimensions = {height: 24, width: 24}
