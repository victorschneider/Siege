...
export const Epicgames: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EpicgamesDimensions = {height: 24, width: 24}
