...
export const Americanexpress: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AmericanexpressDimensions = {height: 24, width: 24}
