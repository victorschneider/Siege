...
export const Wii: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WiiDimensions = {height: 24, width: 24}
