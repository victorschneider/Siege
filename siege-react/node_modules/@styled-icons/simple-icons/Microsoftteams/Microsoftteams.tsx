...
export const Microsoftteams: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftteamsDimensions = {height: 24, width: 24}
