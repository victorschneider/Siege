...
export const Cloudcannon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CloudcannonDimensions = {height: 24, width: 24}
