...
export const Virb: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VirbDimensions = {height: 24, width: 24}
