...
export const Wikimediacommons: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WikimediacommonsDimensions = {height: 24, width: 24}
