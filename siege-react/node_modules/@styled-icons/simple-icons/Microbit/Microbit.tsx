...
export const Microbit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrobitDimensions = {height: 24, width: 24}
