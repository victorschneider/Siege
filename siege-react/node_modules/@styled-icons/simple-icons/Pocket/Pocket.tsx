...
export const Pocket: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PocketDimensions = {height: 24, width: 24}
