...
export const Zalando: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZalandoDimensions = {height: 24, width: 24}
