...
export const Tencentqq: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TencentqqDimensions = {height: 24, width: 24}
