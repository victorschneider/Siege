...
export const Zoom: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZoomDimensions = {height: 24, width: 24}
