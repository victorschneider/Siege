...
export const Celery: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CeleryDimensions = {height: 24, width: 24}
