...
export const Retropie: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RetropieDimensions = {height: 24, width: 24}
