...
export const Abbrobotstudio: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AbbrobotstudioDimensions = {height: 24, width: 24}
