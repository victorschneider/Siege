...
export const Stencyl: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StencylDimensions = {height: 24, width: 24}
