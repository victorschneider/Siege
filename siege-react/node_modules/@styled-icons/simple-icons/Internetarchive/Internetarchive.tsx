...
export const Internetarchive: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InternetarchiveDimensions = {height: 24, width: 24}
