...
export const StyledComponents: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StyledComponentsDimensions = {height: 24, width: 24}
