...
export const Hatenabookmark: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HatenabookmarkDimensions = {height: 24, width: 24}
