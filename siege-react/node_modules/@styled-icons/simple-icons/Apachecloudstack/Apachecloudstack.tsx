...
export const Apachecloudstack: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ApachecloudstackDimensions = {height: 24, width: 24}
