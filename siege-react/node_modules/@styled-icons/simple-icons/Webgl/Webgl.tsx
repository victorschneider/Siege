...
export const Webgl: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WebglDimensions = {height: 24, width: 24}
