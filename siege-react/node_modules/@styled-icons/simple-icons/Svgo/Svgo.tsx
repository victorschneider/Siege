...
export const Svgo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SvgoDimensions = {height: 24, width: 24}
