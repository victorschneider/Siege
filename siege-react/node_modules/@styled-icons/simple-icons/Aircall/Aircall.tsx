...
export const Aircall: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AircallDimensions = {height: 24, width: 24}
