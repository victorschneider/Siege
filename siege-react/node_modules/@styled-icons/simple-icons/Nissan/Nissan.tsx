...
export const Nissan: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NissanDimensions = {height: 24, width: 24}
