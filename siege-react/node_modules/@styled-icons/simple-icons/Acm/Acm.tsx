...
export const Acm: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AcmDimensions = {height: 24, width: 24}
