...
export const Adblock: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdblockDimensions = {height: 24, width: 24}
