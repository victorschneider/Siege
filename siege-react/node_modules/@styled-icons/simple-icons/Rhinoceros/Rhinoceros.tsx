...
export const Rhinoceros: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RhinocerosDimensions = {height: 24, width: 24}
