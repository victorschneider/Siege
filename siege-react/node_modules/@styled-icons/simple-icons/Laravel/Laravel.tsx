...
export const Laravel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LaravelDimensions = {height: 24, width: 24}
