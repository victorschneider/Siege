...
export const Viadeo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ViadeoDimensions = {height: 24, width: 24}
