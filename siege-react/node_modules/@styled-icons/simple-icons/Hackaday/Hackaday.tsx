...
export const Hackaday: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HackadayDimensions = {height: 24, width: 24}
