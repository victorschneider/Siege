...
export const Visualstudiocode: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VisualstudiocodeDimensions = {height: 24, width: 24}
