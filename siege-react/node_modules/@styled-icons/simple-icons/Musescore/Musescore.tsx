...
export const Musescore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MusescoreDimensions = {height: 24, width: 24}
