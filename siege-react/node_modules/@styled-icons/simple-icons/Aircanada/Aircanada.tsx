...
export const Aircanada: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AircanadaDimensions = {height: 24, width: 24}
