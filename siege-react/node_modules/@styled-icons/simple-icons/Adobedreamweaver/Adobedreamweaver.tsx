...
export const Adobedreamweaver: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AdobedreamweaverDimensions = {height: 24, width: 24}
