...
export const Askfm: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AskfmDimensions = {height: 24, width: 24}
