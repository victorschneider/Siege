...
export const Joomla: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const JoomlaDimensions = {height: 24, width: 24}
