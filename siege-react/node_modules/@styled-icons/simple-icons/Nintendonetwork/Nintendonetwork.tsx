...
export const Nintendonetwork: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NintendonetworkDimensions = {height: 24, width: 24}
