...
export const Microsoftoutlook: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MicrosoftoutlookDimensions = {height: 24, width: 24}
