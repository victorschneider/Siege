...
export const Skypeforbusiness: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SkypeforbusinessDimensions = {height: 24, width: 24}
