...
export const Newyorktimes: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NewyorktimesDimensions = {height: 24, width: 24}
