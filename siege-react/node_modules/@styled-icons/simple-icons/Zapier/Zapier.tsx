...
export const Zapier: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZapierDimensions = {height: 24, width: 24}
