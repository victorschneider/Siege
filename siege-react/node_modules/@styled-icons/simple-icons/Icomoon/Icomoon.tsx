...
export const Icomoon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IcomoonDimensions = {height: 24, width: 24}
