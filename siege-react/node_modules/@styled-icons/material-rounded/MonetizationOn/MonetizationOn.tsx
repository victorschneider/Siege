...
export const MonetizationOn: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MonetizationOnDimensions = {height: 24, width: 24}
