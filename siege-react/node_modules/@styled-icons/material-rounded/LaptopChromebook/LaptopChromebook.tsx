...
export const LaptopChromebook: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LaptopChromebookDimensions = {height: 24, width: 24}
