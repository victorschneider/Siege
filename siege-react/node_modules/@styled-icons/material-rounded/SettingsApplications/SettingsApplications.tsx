...
export const SettingsApplications: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsApplicationsDimensions = {height: 24, width: 24}
