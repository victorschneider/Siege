...
export const AirplanemodeActive: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AirplanemodeActiveDimensions = {height: 24, width: 24}
