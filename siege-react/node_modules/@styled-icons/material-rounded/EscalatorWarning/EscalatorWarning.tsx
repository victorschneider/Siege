...
export const EscalatorWarning: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EscalatorWarningDimensions = {height: 24, width: 24}
