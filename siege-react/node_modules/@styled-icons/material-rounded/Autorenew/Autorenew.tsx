...
export const Autorenew: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AutorenewDimensions = {height: 24, width: 24}
