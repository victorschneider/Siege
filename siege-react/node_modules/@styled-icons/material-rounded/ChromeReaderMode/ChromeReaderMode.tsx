...
export const ChromeReaderMode: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChromeReaderModeDimensions = {height: 24, width: 24}
