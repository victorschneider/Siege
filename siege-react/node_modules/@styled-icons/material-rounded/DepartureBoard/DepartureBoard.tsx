...
export const DepartureBoard: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DepartureBoardDimensions = {height: 24, width: 24}
