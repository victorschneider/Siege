...
export const FormatUnderlined: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatUnderlinedDimensions = {height: 24, width: 24}
