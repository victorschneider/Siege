...
export const NotListedLocation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NotListedLocationDimensions = {height: 24, width: 24}
