...
export const CollectionsBookmark: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CollectionsBookmarkDimensions = {height: 24, width: 24}
