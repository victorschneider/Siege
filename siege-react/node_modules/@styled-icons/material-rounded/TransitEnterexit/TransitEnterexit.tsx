...
export const TransitEnterexit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TransitEnterexitDimensions = {height: 24, width: 24}
