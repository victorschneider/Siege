...
export const CloseFullscreen: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CloseFullscreenDimensions = {height: 24, width: 24}
