...
export const PlaylistAddCheck: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlaylistAddCheckDimensions = {height: 24, width: 24}
