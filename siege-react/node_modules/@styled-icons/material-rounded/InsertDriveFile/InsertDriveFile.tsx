...
export const InsertDriveFile: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InsertDriveFileDimensions = {height: 24, width: 24}
