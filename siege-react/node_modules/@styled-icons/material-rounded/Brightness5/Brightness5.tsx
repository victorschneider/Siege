...
export const Brightness5: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Brightness5Dimensions = {height: 24, width: 24}
