...
export const Replay5: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Replay5Dimensions = {height: 24, width: 24}
