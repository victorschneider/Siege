...
export const LocationCity: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationCityDimensions = {height: 24, width: 24}
