...
export const Cake: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CakeDimensions = {height: 24, width: 24}
