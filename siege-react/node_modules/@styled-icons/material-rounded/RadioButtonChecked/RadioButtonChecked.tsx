...
export const RadioButtonChecked: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RadioButtonCheckedDimensions = {height: 24, width: 24}
