...
export const LocalConvenienceStore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocalConvenienceStoreDimensions = {height: 24, width: 24}
