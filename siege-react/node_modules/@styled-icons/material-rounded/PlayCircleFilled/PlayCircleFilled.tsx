...
export const PlayCircleFilled: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlayCircleFilledDimensions = {height: 24, width: 24}
