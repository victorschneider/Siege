...
export const LabelImportant: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LabelImportantDimensions = {height: 24, width: 24}
