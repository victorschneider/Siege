...
export const VerticalAlignBottom: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VerticalAlignBottomDimensions = {height: 24, width: 24}
