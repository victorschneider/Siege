...
export const SettingsInputComponent: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsInputComponentDimensions = {height: 24, width: 24}
