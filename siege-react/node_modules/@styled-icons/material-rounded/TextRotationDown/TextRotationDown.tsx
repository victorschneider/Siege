...
export const TextRotationDown: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TextRotationDownDimensions = {height: 24, width: 24}
