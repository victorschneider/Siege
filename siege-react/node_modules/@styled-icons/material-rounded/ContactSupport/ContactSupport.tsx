...
export const ContactSupport: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ContactSupportDimensions = {height: 24, width: 24}
