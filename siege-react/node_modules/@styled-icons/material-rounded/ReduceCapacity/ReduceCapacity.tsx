...
export const ReduceCapacity: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ReduceCapacityDimensions = {height: 24, width: 24}
