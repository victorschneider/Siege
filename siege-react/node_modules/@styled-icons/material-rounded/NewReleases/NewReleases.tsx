...
export const NewReleases: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NewReleasesDimensions = {height: 24, width: 24}
