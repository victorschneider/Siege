...
export const CameraRear: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CameraRearDimensions = {height: 24, width: 24}
