...
export const FormatLineSpacing: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatLineSpacingDimensions = {height: 24, width: 24}
