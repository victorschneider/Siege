...
export const ArrowDropDownCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowDropDownCircleDimensions = {height: 24, width: 24}
