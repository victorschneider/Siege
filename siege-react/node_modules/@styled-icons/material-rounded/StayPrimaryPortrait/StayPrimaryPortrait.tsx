...
export const StayPrimaryPortrait: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StayPrimaryPortraitDimensions = {height: 24, width: 24}
