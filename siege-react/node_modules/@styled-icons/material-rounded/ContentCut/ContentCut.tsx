...
export const ContentCut: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ContentCutDimensions = {height: 24, width: 24}
