...
export const AccessibilityNew: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AccessibilityNewDimensions = {height: 24, width: 24}
