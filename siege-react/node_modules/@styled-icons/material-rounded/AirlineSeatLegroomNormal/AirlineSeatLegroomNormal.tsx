...
export const AirlineSeatLegroomNormal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AirlineSeatLegroomNormalDimensions = {height: 24, width: 24}
