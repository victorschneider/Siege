...
export const FlipCameraAndroid: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FlipCameraAndroidDimensions = {height: 24, width: 24}
