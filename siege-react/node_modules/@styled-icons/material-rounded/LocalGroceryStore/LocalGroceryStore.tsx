...
export const LocalGroceryStore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocalGroceryStoreDimensions = {height: 24, width: 24}
