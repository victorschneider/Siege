...
export const CancelScheduleSend = /*#__PURE__*/React.forwardRef((props, ref) => {
  const attrs = {
    "fill": "currentColor",
...
export const CancelScheduleSendDimensions = {
  height: 24,
  width: 24
};