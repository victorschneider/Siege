...
export const LocalPostOffice: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocalPostOfficeDimensions = {height: 24, width: 24}
