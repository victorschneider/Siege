...
export const ContactMail: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ContactMailDimensions = {height: 24, width: 24}
