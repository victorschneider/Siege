...
export const Rule: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RuleDimensions = {height: 24, width: 24}
