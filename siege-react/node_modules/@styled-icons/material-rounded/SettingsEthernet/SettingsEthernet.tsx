...
export const SettingsEthernet: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsEthernetDimensions = {height: 24, width: 24}
