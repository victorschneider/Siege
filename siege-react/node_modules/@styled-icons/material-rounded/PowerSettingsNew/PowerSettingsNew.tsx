...
export const PowerSettingsNew: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PowerSettingsNewDimensions = {height: 24, width: 24}
