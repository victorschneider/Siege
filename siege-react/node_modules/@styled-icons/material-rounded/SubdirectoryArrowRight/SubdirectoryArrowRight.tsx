...
export const SubdirectoryArrowRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SubdirectoryArrowRightDimensions = {height: 24, width: 24}
