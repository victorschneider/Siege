...
export const AirlineSeatIndividualSuite: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AirlineSeatIndividualSuiteDimensions = {height: 24, width: 24}
