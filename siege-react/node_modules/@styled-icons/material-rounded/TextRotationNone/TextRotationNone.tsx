...
export const TextRotationNone: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TextRotationNoneDimensions = {height: 24, width: 24}
