...
export const FormatIndentDecrease: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatIndentDecreaseDimensions = {height: 24, width: 24}
