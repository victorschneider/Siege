...
export const ConnectWithoutContact: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ConnectWithoutContactDimensions = {height: 24, width: 24}
