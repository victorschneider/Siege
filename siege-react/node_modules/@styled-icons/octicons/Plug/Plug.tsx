...
export const Plug: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlugDimensions = {height: 16, width: 16}
