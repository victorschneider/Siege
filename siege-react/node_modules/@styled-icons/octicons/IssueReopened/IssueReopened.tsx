...
export const IssueReopened: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IssueReopenedDimensions = {height: 16, width: 16}
