...
export const Workflow: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WorkflowDimensions = {height: 16, width: 16}
