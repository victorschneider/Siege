...
export const Squirrel: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SquirrelDimensions = {height: 16, width: 16}
