...
export const FileMedia: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileMediaDimensions = {height: 24, width: 24}
