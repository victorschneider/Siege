...
export const Server: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ServerDimensions = {height: 16, width: 16}
