...
export const Mirror: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MirrorDimensions = {height: 16, width: 16}
