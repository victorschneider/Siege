...
export const MortarBoard: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MortarBoardDimensions = {height: 16, width: 16}
