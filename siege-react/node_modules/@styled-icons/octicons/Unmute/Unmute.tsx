...
export const Unmute: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UnmuteDimensions = {height: 16, width: 16}
