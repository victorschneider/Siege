...
export const CommentDiscussion: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CommentDiscussionDimensions = {height: 16, width: 16}
