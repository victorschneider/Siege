...
export const DesktopDownload: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DesktopDownloadDimensions = {height: 16, width: 16}
