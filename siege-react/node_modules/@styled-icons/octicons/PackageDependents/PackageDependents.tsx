...
export const PackageDependents: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PackageDependentsDimensions = {height: 16, width: 16}
