...
export const PackageDependencies: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PackageDependenciesDimensions = {height: 16, width: 16}
