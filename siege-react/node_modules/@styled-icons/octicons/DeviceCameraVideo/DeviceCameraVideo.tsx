...
export const DeviceCameraVideo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DeviceCameraVideoDimensions = {height: 16, width: 16}
