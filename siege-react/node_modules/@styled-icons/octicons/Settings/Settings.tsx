...
export const Settings: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsDimensions = {height: 24, width: 24}
