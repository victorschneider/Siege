...
export const Unverifed: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UnverifedDimensions = {height: 24, width: 24}
