...
export const Cpu: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CpuDimensions = {height: 16, width: 16}
