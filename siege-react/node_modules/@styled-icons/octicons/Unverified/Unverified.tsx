...
export const Unverified: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UnverifiedDimensions = {height: 16, width: 16}
