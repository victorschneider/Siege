...
export const Zap: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ZapDimensions = {height: 16, width: 16}
