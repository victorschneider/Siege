...
export const BellSlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BellSlashDimensions = {height: 16, width: 16}
