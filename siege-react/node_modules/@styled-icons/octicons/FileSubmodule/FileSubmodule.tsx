...
export const FileSubmodule: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileSubmoduleDimensions = {height: 16, width: 16}
