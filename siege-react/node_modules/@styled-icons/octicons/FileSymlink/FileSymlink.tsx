...
export const FileSymlink: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileSymlinkDimensions = {height: 24, width: 24}
