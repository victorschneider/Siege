...
export const FileSymlinkFile: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileSymlinkFileDimensions = {height: 16, width: 16}
