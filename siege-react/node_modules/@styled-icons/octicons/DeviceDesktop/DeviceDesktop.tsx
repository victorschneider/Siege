...
export const DeviceDesktop: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DeviceDesktopDimensions = {height: 16, width: 16}
