...
export const BookmarkSlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BookmarkSlashDimensions = {height: 16, width: 16}
