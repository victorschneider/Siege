...
export const Nebl: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NeblDimensions = {height: 32, width: 32}
