...
export const Bcn: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BcnDimensions = {height: 32, width: 32}
