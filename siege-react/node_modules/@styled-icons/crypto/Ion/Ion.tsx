...
export const Ion: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IonDimensions = {height: 32, width: 32}
