...
export const Yoyow: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const YoyowDimensions = {height: 32, width: 32}
