...
export const Lbc: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LbcDimensions = {height: 32, width: 32}
