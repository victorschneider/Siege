...
export const Qtum: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QtumDimensions = {height: 32, width: 32}
