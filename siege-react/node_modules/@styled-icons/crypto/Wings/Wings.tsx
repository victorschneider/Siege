...
export const Wings: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  <g fillRule="nonzero">
    <path fillOpacity={.7} d="M16.895 17.299l-1.036.804-1.247-4.325-7.224-1.935 8.028.413z" />
    <path fillOpacity={.3} d="M16.895 17.299l.778 2.652L22 18.118 8.27 23.993zm3.873-3.006l3.818-2.963L26 14.476l-1.855-.513-.065 3.264-1.285.55z" />
  </g>
</g>
...
export const WingsDimensions = {height: 32, width: 32}
