...
export const Eon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EonDimensions = {height: 32, width: 32}
