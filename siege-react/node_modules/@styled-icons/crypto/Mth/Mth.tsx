...
export const Mth: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path fillOpacity={.5} d="M7 9.568l4.234 7.103V24C8.896 24 7 22.164 7 19.899z" />

      <path fillOpacity={.4} d="M20.765 16.663l4.232-7.099h.002V19.9C25 22.164 23.104 24 20.765 24z" />

      <path fillOpacity={.198} d="M15.997 16.458L13.88 20.01c-.439-.11-.911-.536-1.416-1.277L7 9.568c2.025-1.133 4.615-.46 5.784 1.5z" />
...
export const MthDimensions = {height: 32, width: 32}
