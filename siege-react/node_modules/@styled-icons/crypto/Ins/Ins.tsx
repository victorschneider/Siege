...
export const Ins: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InsDimensions = {height: 32, width: 32}
