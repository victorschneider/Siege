...
export const Ric: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RicDimensions = {height: 32, width: 32}
