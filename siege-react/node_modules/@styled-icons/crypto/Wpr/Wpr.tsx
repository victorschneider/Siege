...
export const Wpr: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WprDimensions = {height: 32, width: 32}
