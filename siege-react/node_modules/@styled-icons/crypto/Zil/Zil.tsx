...
export const Zil: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path fillOpacity={.65} d="M9 7.281l11.114 5.383 2.845-1.282L11.891 6z" />

      <path fillOpacity={.3} d="M20.114 12.651l2.845-1.281v2.865l-2.845 1.281zm0 13.284v-8.937l2.845-1.295v8.951z" />
...
export const ZilDimensions = {height: 32, width: 32}
