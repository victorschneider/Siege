...
export const Bcd: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BcdDimensions = {height: 32, width: 32}
