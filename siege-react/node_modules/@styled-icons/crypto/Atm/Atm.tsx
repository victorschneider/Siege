...
export const Atm: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AtmDimensions = {height: 32, width: 32}
