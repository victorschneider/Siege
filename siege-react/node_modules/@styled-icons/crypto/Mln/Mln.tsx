...
export const Mln: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MlnDimensions = {height: 32, width: 32}
