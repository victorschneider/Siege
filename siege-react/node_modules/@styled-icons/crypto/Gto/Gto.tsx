...
export const Gto: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GtoDimensions = {height: 32, width: 32}
