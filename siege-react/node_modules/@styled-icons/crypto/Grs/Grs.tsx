...
export const Grs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GrsDimensions = {height: 32, width: 32}
