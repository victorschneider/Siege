...
export const Html: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HtmlDimensions = {height: 32, width: 32}
