...
export const Evx: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EvxDimensions = {height: 32, width: 32}
