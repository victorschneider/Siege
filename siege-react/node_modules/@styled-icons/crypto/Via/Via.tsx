...
export const Via: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ViaDimensions = {height: 32, width: 32}
