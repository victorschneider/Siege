...
export const Hpb: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HpbDimensions = {height: 32, width: 32}
