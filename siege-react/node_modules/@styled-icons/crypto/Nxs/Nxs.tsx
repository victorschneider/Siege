...
export const Nxs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NxsDimensions = {height: 32, width: 32}
