...
export const Ethos: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EthosDimensions = {height: 32, width: 32}
