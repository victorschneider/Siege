...
export const Command: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CommandDimensions = {height: 16, width: 16}
