...
export const Wink2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Wink2Dimensions = {height: 16, width: 16}
