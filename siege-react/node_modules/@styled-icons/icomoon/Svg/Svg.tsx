...
export const Svg: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SvgDimensions = {height: 16, width: 16}
