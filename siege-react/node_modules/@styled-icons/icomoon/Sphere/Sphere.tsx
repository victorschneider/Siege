...
export const Sphere: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SphereDimensions = {height: 16, width: 16}
