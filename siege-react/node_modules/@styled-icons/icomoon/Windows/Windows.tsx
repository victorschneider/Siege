...
export const Windows: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WindowsDimensions = {height: 16, width: 16}
