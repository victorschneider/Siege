...
export const Spotify: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SpotifyDimensions = {height: 16, width: 16}
