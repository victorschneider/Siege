...
export const Vimeo2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Vimeo2Dimensions = {height: 16, width: 16}
