...
export const EyeMinus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EyeMinusDimensions = {height: 16, width: 16}
