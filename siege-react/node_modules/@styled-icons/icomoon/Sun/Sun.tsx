...
export const Sun: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SunDimensions = {height: 16, width: 16}
