...
export const Mail4: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Mail4Dimensions = {height: 16, width: 16}
