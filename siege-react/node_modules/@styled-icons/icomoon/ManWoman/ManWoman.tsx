...
export const ManWoman: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ManWomanDimensions = {height: 16, width: 16}
