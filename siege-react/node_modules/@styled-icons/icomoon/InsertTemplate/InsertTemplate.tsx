...
export const InsertTemplate: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InsertTemplateDimensions = {height: 16, width: 16}
