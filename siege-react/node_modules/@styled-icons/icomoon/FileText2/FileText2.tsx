...
export const FileText2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M11.5 13h-7a.5.5 0 010-1h7a.5.5 0 010 1zM11.5 11h-7a.5.5 0 010-1h7a.5.5 0 010 1zM11.5 9h-7a.5.5 0 010-1h7a.5.5 0 010 1z" />
...
export const FileText2Dimensions = {height: 16, width: 16}
