...
export const EyeBlocked: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M12.969 4.531l-1.084 1.084.059.037c.94.6 1.737 1.403 2.335 2.348a7.594 7.594 0 01-2.335 2.348 7.326 7.326 0 01-5.725.933l-1.201 1.201A8.808 8.808 0 008 13c3.489 0 6.514-2.032 8-5a9.142 9.142 0 00-3.031-3.469z" />
...
export const EyeBlockedDimensions = {height: 16, width: 16}
