...
export const Wink: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WinkDimensions = {height: 16, width: 16}
