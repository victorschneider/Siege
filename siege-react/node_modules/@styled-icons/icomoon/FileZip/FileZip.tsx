...
export const FileZip: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M4 1h2v1H4V1zM6 2h2v1H6V2zM4 3h2v1H4V3zM6 4h2v1H6V4zM4 5h2v1H4V5zM6 6h2v1H6V6zM4 7h2v1H4V7zM6 8h2v1H6V8zM4 13.25c0 .412.338.75.75.75h2.5c.412 0 .75-.338.75-.75v-2.5a.753.753 0 00-.75-.75H6V9H4v4.25zM7 12v1H5v-1h2z" />
...
export const FileZipDimensions = {height: 16, width: 16}
