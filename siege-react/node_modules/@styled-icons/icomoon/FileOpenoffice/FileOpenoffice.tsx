...
export const FileOpenoffice: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileOpenofficeDimensions = {height: 16, width: 16}
