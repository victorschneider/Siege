...
export const ClearFormatting: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ClearFormattingDimensions = {height: 16, width: 16}
