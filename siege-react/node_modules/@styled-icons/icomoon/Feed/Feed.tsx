...
export const Feed: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FeedDimensions = {height: 16, width: 16}
