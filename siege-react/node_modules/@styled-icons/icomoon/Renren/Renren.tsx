...
export const Renren: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RenrenDimensions = {height: 16, width: 16}
