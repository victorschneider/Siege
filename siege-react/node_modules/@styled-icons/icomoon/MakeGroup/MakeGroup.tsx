...
export const MakeGroup: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MakeGroupDimensions = {height: 16, width: 16}
