...
export const Section: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SectionDimensions = {height: 16, width: 16}
