...
export const FilePicture: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path d="M13 14H3v-2l3-5 4.109 5L13 10v4zM13 7.5a1.5 1.5 0 11-3.001-.001A1.5 1.5 0 0113 7.5z" />
...
export const FilePictureDimensions = {height: 16, width: 16}
