...
export const Appleinc: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AppleincDimensions = {height: 16, width: 16}
