...
export const Yelp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const YelpDimensions = {height: 16, width: 16}
