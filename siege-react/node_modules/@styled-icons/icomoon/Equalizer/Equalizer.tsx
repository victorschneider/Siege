...
export const Equalizer: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EqualizerDimensions = {height: 16, width: 16}
