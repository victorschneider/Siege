...
export const Youtube2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Youtube2Dimensions = {height: 16, width: 40}
