...
export const Cogs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CogsDimensions = {height: 16, width: 16}
