...
export const FilePlay: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FilePlayDimensions = {height: 16, width: 16}
