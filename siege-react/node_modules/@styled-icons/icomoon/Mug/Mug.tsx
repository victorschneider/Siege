...
export const Mug: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MugDimensions = {height: 16, width: 16}
