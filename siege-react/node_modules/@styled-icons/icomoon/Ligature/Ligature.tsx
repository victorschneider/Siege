...
export const Ligature: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LigatureDimensions = {height: 16, width: 16}
