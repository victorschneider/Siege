...
export const SinaWeibo: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SinaWeiboDimensions = {height: 16, width: 16}
