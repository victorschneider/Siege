...
export const PowerCord: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PowerCordDimensions = {height: 16, width: 16}
