...
export const CircleLeft: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M10.457 4.957L9.043 3.543 4.586 8l4.457 4.457 1.414-1.414L7.414 8z" />
...
export const CircleLeftDimensions = {height: 16, width: 16}
