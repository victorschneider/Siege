...
export const Frustrated2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Frustrated2Dimensions = {height: 16, width: 16}
