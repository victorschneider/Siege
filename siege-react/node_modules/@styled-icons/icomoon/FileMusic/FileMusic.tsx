...
export const FileMusic: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M11.817 6.113a.501.501 0 00-.415-.104l-5 1a.5.5 0 00-.402.49V11.2a2.514 2.514 0 00-1-.201c-1.105 0-2 .672-2 1.5s.895 1.5 2 1.5 2-.672 2-1.5v-3.59l4-.8V10.2a2.514 2.514 0 00-1-.201c-1.105 0-2 .672-2 1.5s.895 1.5 2 1.5 2-.672 2-1.5v-5a.5.5 0 00-.183-.387z" />
...
export const FileMusicDimensions = {height: 16, width: 16}
