...
export const Pinterest2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Pinterest2Dimensions = {height: 16, width: 16}
