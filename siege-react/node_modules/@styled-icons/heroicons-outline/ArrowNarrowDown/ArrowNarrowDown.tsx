...
export const ArrowNarrowDown: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowNarrowDownDimensions = {height: 24, width: 24}
