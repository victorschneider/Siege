...
export const ChartSquareBar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChartSquareBarDimensions = {height: 24, width: 24}
