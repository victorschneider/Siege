...
export const ArrowNarrowLeft: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowNarrowLeftDimensions = {height: 24, width: 24}
