...
export const Envelope: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path d="M31.796 24.244l9.97 9.97-1.415 1.414-9.97-9.97zM18.278 24.287l1.414 1.414-9.9 9.9-1.414-1.41z" opacity={.9} />
...
export const EnvelopeDimensions = {height: 50, width: 50}
