...
export const SettingsOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SettingsOutlineDimensions = {height: 24, width: 24}
