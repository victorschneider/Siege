...
export const ShoppingCartOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShoppingCartOutlineDimensions = {height: 24, width: 24}
