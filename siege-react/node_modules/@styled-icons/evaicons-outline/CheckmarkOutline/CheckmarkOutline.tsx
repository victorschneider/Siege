...
export const CheckmarkOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckmarkOutlineDimensions = {height: 24, width: 24}
