...
export const DiagonalArrowLeftUpOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DiagonalArrowLeftUpOutlineDimensions = {height: 24, width: 24}
