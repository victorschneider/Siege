...
export const CodeDownloadOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CodeDownloadOutlineDimensions = {height: 24, width: 24}
