...
export const ArrowheadLeftOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowheadLeftOutlineDimensions = {height: 24, width: 24}
