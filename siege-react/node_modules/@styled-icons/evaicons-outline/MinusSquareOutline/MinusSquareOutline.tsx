...
export const MinusSquareOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MinusSquareOutlineDimensions = {height: 24, width: 24}
