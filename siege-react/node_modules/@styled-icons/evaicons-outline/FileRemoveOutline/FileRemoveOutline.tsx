...
export const FileRemoveOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileRemoveOutlineDimensions = {height: 24, width: 24}
