...
export const ChargingOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChargingOutlineDimensions = {height: 24, width: 24}
