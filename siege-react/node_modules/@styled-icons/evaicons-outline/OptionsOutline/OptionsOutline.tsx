...
export const OptionsOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const OptionsOutlineDimensions = {height: 24, width: 24}
