...
export const MoreHorizontalOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MoreHorizontalOutlineDimensions = {height: 24, width: 24}
