...
export const CloseCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CloseCircleOutlineDimensions = {height: 24, width: 24}
