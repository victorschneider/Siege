...
export const StopCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StopCircleOutlineDimensions = {height: 24, width: 24}
