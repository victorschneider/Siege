...
export const ExternalLinkOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ExternalLinkOutlineDimensions = {height: 24, width: 24}
