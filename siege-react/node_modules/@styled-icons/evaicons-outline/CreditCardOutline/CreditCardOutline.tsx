...
export const CreditCardOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreditCardOutlineDimensions = {height: 24, width: 24}
