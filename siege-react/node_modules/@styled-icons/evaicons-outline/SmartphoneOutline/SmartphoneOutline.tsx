...
export const SmartphoneOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SmartphoneOutlineDimensions = {height: 24, width: 24}
