...
export const ArrowIosForwardOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowIosForwardOutlineDimensions = {height: 24, width: 24}
