...
export const PlusSquareOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlusSquareOutlineDimensions = {height: 24, width: 24}
