...
export const FileTextOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileTextOutlineDimensions = {height: 24, width: 24}
