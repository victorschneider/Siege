...
export const BrowserOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BrowserOutlineDimensions = {height: 24, width: 24}
