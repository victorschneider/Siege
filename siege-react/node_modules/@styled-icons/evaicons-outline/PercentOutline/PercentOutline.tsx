...
export const PercentOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PercentOutlineDimensions = {height: 24, width: 24}
