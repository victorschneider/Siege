...
export const BellOffOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BellOffOutlineDimensions = {height: 24, width: 24}
