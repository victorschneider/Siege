...
export const ShoppingBagOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShoppingBagOutlineDimensions = {height: 24, width: 24}
