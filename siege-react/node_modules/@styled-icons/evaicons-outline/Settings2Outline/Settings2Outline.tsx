...
export const Settings2Outline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Settings2OutlineDimensions = {height: 24, width: 24}
