...
export const MessageSquareOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageSquareOutlineDimensions = {height: 24, width: 24}
