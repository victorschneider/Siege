...
export const PlusCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlusCircleOutlineDimensions = {height: 24, width: 24}
