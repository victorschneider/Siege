...
export const ArrowheadUpOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowheadUpOutlineDimensions = {height: 24, width: 24}
