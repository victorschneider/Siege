...
export const CheckmarkSquare2Outline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckmarkSquare2OutlineDimensions = {height: 24, width: 24}
