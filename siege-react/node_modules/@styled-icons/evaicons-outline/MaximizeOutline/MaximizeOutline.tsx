...
export const MaximizeOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MaximizeOutlineDimensions = {height: 24, width: 24}
