...
export const HardDriveOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HardDriveOutlineDimensions = {height: 24, width: 24}
