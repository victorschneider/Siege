...
export const CloseSquareOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CloseSquareOutlineDimensions = {height: 24, width: 24}
