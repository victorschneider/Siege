...
export const ArrowheadDownOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowheadDownOutlineDimensions = {height: 24, width: 24}
