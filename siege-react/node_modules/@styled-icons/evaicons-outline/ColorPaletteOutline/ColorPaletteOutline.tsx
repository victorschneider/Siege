...
export const ColorPaletteOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ColorPaletteOutlineDimensions = {height: 24, width: 24}
