...
export const FolderRemoveOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderRemoveOutlineDimensions = {height: 24, width: 24}
