...
export const PersonDeleteOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PersonDeleteOutlineDimensions = {height: 24, width: 24}
