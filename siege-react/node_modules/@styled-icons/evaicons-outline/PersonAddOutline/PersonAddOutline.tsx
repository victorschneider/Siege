...
export const PersonAddOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PersonAddOutlineDimensions = {height: 24, width: 24}
