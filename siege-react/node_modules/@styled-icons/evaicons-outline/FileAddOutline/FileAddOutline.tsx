...
export const FileAddOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileAddOutlineDimensions = {height: 24, width: 24}
