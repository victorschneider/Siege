...
export const CollapseOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CollapseOutlineDimensions = {height: 24, width: 24}
