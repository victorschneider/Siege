...
export const FolderAddOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderAddOutlineDimensions = {height: 24, width: 24}
