...
export const QuestionMarkOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuestionMarkOutlineDimensions = {height: 24, width: 24}
