...
export const QuestionMarkCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuestionMarkCircleOutlineDimensions = {height: 24, width: 24}
