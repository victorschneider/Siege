...
export const SpeakerOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SpeakerOutlineDimensions = {height: 24, width: 24}
