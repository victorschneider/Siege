...
export const ShuffleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShuffleOutlineDimensions = {height: 24, width: 24}
