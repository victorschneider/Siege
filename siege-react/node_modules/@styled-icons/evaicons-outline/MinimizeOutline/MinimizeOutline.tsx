...
export const MinimizeOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MinimizeOutlineDimensions = {height: 24, width: 24}
