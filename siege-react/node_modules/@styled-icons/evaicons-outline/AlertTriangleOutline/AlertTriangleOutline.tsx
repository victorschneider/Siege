...
export const AlertTriangleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AlertTriangleOutlineDimensions = {height: 24, width: 24}
