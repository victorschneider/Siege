...
export const MessageCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageCircleOutlineDimensions = {height: 24, width: 24}
