...
export const PieChartOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PieChartOutlineDimensions = {height: 24, width: 24}
