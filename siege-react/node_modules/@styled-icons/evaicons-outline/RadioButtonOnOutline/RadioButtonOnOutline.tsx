...
export const RadioButtonOnOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RadioButtonOnOutlineDimensions = {height: 24, width: 24}
