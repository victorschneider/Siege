...
export const PhoneCallOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhoneCallOutlineDimensions = {height: 24, width: 24}
