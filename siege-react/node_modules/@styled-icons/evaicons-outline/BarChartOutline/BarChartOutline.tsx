...
export const BarChartOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BarChartOutlineDimensions = {height: 24, width: 24}
