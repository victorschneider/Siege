...
export const VolumeOffOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VolumeOffOutlineDimensions = {height: 24, width: 24}
