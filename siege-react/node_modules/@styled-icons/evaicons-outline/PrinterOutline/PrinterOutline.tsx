...
export const PrinterOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PrinterOutlineDimensions = {height: 24, width: 24}
