...
export const CompassOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CompassOutlineDimensions = {height: 24, width: 24}
