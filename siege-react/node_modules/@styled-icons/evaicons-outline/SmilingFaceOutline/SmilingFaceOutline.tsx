...
export const SmilingFaceOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SmilingFaceOutlineDimensions = {height: 24, width: 24}
