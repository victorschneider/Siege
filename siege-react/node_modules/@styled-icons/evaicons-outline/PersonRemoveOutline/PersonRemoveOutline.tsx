...
export const PersonRemoveOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PersonRemoveOutlineDimensions = {height: 24, width: 24}
