...
export const WifiOffOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WifiOffOutlineDimensions = {height: 24, width: 24}
