...
export const PricetagsOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PricetagsOutlineDimensions = {height: 24, width: 24}
