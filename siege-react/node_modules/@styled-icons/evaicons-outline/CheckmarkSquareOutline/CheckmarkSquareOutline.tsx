...
export const CheckmarkSquareOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckmarkSquareOutlineDimensions = {height: 24, width: 24}
