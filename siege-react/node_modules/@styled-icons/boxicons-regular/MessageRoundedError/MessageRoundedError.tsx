...
export const MessageRoundedError: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageRoundedErrorDimensions = {height: 24, width: 24}
