...
export const LeftArrowCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LeftArrowCircleDimensions = {height: 24, width: 24}
