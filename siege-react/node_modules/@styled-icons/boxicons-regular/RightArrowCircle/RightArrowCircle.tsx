...
export const RightArrowCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RightArrowCircleDimensions = {height: 24, width: 24}
