...
export const MicrophoneOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M8.011 12.132a3.993 3.993 0 003.877 3.877l-3.877-3.877z" />
...
export const MicrophoneOffDimensions = {height: 24, width: 24}
