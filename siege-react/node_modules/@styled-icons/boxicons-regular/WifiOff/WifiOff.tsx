...
export const WifiOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const WifiOffDimensions = {height: 24, width: 24}
