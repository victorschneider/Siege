...
export const Reset: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ResetDimensions = {height: 24, width: 24}
