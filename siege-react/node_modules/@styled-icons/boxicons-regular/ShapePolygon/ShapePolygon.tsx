...
export const ShapePolygon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShapePolygonDimensions = {height: 24, width: 24}
