...
export const MessageSquareError: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageSquareErrorDimensions = {height: 24, width: 24}
