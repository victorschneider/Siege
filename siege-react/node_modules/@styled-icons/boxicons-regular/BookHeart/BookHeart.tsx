...
export const BookHeart: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M11.997 14l3.35-3.289a2.129 2.129 0 000-3.069 2.225 2.225 0 00-3.126 0l-.224.218-.224-.219a2.224 2.224 0 00-3.125 0 2.129 2.129 0 000 3.069L11.997 14z" />
...
export const BookHeartDimensions = {height: 24, width: 24}
