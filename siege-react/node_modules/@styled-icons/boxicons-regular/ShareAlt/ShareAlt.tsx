...
export const ShareAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <circle cx={17.5} cy={18.5} r={1.5} fill="none" />

      <circle cx={5.5} cy={11.5} r={1.5} fill="none" />

      <circle cx={17.5} cy={5.5} r={1.5} fill="none" />
...
export const ShareAltDimensions = {height: 24, width: 24}
