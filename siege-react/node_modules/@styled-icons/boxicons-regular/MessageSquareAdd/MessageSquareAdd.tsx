...
export const MessageSquareAdd: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageSquareAddDimensions = {height: 24, width: 24}
