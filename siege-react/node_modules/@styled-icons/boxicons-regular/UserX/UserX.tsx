...
export const UserX: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UserXDimensions = {height: 24, width: 24}
