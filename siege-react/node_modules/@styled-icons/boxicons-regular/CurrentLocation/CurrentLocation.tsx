...
export const CurrentLocation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CurrentLocationDimensions = {height: 24, width: 24}
