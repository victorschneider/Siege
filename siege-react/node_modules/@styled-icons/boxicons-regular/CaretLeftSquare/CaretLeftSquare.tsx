...
export const CaretLeftSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CaretLeftSquareDimensions = {height: 24, width: 24}
