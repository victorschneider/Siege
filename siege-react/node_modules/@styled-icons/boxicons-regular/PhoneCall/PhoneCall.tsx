...
export const PhoneCall: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhoneCallDimensions = {height: 24, width: 24}
