...
export const MessageSquareDetail: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageSquareDetailDimensions = {height: 24, width: 24}
