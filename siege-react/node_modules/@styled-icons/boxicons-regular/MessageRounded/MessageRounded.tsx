...
export const MessageRounded: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageRoundedDimensions = {height: 24, width: 24}
