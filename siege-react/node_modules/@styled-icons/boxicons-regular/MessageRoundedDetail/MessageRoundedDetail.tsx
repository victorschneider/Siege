...
export const MessageRoundedDetail: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MessageRoundedDetailDimensions = {height: 24, width: 24}
