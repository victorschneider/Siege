...
export const DockRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path fill="none" d="M16 5h3.002v14H16zM5 5h9v14H5z" />
...
export const DockRightDimensions = {height: 24, width: 24}
