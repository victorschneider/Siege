...
export const PackageIcon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PackageIconDimensions = {height: 24, width: 24}
