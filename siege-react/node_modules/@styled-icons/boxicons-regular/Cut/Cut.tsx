...
export const Cut: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CutDimensions = {height: 24, width: 24}
