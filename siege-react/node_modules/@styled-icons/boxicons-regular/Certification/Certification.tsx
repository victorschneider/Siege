...
export const Certification: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CertificationDimensions = {height: 24, width: 24}
