...
export const ChevronUpSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChevronUpSquareDimensions = {height: 24, width: 24}
