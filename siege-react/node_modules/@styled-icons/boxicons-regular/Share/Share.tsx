...
export const Share: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ShareDimensions = {height: 24, width: 24}
