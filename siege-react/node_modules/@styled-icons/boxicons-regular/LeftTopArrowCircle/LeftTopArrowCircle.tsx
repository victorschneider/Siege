...
export const LeftTopArrowCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LeftTopArrowCircleDimensions = {height: 24, width: 24}
