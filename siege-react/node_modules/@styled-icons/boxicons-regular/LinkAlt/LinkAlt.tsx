...
export const LinkAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LinkAltDimensions = {height: 24, width: 24}
