...
export const SkipNextCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SkipNextCircleDimensions = {height: 24, width: 24}
