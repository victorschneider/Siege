...
export const Stopwatch: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <path d="M11 9h2v5h-2zM9 2h6v2H9zM19.293 7.707l-2-2 1.414-1.414 2 2z" />
...
export const StopwatchDimensions = {height: 24, width: 24}
