...
export const TwitterWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TwitterWithCircleDimensions = {height: 20, width: 20}
