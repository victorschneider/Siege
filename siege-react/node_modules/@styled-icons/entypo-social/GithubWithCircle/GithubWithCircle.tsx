...
export const GithubWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GithubWithCircleDimensions = {height: 20, width: 20}
