...
export const TumblrWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const TumblrWithCircleDimensions = {height: 20, width: 20}
