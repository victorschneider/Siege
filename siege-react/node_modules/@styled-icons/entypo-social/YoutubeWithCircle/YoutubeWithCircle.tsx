...
export const YoutubeWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const YoutubeWithCircleDimensions = {height: 20, width: 20}
