...
export const LastfmWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LastfmWithCircleDimensions = {height: 20, width: 20}
