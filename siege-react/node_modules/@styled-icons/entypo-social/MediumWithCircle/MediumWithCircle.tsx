...
export const MediumWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MediumWithCircleDimensions = {height: 20, width: 20}
