...
export const RdioWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RdioWithCircleDimensions = {height: 20, width: 20}
