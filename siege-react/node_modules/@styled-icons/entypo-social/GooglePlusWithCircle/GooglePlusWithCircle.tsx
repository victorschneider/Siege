...
export const GooglePlusWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglePlusWithCircleDimensions = {height: 20, width: 20}
