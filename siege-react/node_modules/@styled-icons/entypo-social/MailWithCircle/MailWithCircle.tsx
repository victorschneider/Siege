...
export const MailWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MailWithCircleDimensions = {height: 20, width: 20}
