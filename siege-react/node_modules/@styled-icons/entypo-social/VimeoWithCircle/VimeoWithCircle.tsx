...
export const VimeoWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VimeoWithCircleDimensions = {height: 20, width: 20}
