...
export const YoukoWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const YoukoWithCircleDimensions = {height: 20, width: 20}
