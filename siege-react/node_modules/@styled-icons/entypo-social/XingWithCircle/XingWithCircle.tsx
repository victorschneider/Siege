...
export const XingWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const XingWithCircleDimensions = {height: 20, width: 20}
