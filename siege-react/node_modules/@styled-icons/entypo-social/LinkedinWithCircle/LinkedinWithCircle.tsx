...
export const LinkedinWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LinkedinWithCircleDimensions = {height: 20, width: 20}
