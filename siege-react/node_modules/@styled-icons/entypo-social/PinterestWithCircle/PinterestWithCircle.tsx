...
export const PinterestWithCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PinterestWithCircleDimensions = {height: 20, width: 20}
