...
export const CheckmarkCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckmarkCircleDimensions = {height: 512, width: 512}
