...
export const NotificationsOffCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NotificationsOffCircleDimensions = {height: 512, width: 512}
