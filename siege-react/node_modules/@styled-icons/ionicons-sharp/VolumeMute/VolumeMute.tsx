...
export const VolumeMute: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <line x1={416} x2={64} y1={432} y2={80} fill="none" stroke="currentColor" strokeLinecap="square" strokeMiterlimit={10} strokeWidth={32} />
      ...
      <path d="M480 256c0-74.26-20.19-121.11-50.51-168.61l-8.61-13.49-27 17.22 8.61 13.49C429.82 147.38 448 189.5 448 256c0 48.76-9.4 84-24.82 115.55l23.7 23.7C470.16 351.39 480 309 480 256z" />
...
export const VolumeMuteDimensions = {height: 512, width: 512}
