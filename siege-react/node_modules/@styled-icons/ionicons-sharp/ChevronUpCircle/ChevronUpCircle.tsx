...
export const ChevronUpCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChevronUpCircleDimensions = {height: 512, width: 512}
