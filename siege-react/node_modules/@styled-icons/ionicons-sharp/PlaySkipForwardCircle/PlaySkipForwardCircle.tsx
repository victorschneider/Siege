...
export const PlaySkipForwardCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlaySkipForwardCircleDimensions = {height: 512, width: 512}
