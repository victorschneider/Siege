...
export const ChatbubbleEllipses: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChatbubbleEllipsesDimensions = {height: 512, width: 512}
