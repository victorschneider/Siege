...
export const Pizza: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <ellipse cx={320.48} cy={207.99} fill="none" rx={31.97} ry={32.03} transform="rotate(-44.98 320.503 207.996)" />

      <ellipse cx={192.48} cy={191.99} fill="none" rx={31.97} ry={32.03} transform="rotate(-44.98 192.49 191.992)" />

      <ellipse cx={256.48} cy={319.99} fill="none" rx={31.97} ry={32.03} transform="rotate(-44.98 256.505 320)" />
...
export const PizzaDimensions = {height: 512, width: 512}
