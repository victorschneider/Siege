...
export const EyeOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <rect width={31.11} height={511.95} x={240.44} y={.03} transform="rotate(-45 256 256.002)" />

      <path d="M259.34 192.09l60.57 60.57a64.07 64.07 0 00-60.57-60.57zM252.66 319.91l-60.57-60.57a64.07 64.07 0 0060.57 60.57z" />
...
export const EyeOffDimensions = {height: 512, width: 512}
