...
export const PartlySunny: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={64} height={32} x={448} y={192} />

      <rect width={32} height={64} x={320} y={32} />

      <path d="M255.35 129.63l12.45-12.45-44.62-44.63-22.63 22.63 33.17 33.17h.6a172 172 0 0121.03 1.28z" />

      <rect width={63.11} height={32} x={406.27} y={90.18} transform="rotate(-45 437.817 106.17)" />
