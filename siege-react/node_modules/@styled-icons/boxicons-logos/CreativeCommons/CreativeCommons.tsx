...
export const CreativeCommons: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsDimensions = {height: 24, width: 24}
