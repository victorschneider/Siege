...
export const GooglePlusCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const GooglePlusCircleDimensions = {height: 24, width: 24}
