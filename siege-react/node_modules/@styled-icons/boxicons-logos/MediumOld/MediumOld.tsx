...
export const MediumOld: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MediumOldDimensions = {height: 24, width: 24}
