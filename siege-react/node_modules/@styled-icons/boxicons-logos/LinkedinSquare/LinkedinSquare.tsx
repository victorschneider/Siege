...
export const LinkedinSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LinkedinSquareDimensions = {height: 24, width: 24}
