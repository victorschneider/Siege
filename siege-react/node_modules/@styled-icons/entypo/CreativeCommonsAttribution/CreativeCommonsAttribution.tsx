...
export const CreativeCommonsAttribution: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsAttributionDimensions = {height: 20, width: 20}
