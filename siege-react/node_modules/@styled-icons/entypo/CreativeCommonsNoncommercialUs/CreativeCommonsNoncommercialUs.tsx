...
export const CreativeCommonsNoncommercialUs: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsNoncommercialUsDimensions = {height: 20, width: 20}
