...
export const LightBulb: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LightBulbDimensions = {height: 20, width: 20}
