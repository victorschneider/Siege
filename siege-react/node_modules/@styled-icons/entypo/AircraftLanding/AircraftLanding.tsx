...
export const AircraftLanding: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AircraftLandingDimensions = {height: 20, width: 20}
