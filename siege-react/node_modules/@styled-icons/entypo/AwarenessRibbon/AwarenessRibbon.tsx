...
export const AwarenessRibbon: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AwarenessRibbonDimensions = {height: 20, width: 20}
