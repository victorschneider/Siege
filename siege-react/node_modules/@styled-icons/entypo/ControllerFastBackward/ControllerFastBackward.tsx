...
export const ControllerFastBackward: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ControllerFastBackwardDimensions = {height: 20, width: 20}
