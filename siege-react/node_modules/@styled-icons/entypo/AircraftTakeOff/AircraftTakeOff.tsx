...
export const AircraftTakeOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AircraftTakeOffDimensions = {height: 20, width: 20}
