...
export const CreativeCommonsSharealike: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsSharealikeDimensions = {height: 20, width: 20}
