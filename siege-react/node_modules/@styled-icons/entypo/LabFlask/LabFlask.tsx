...
export const LabFlask: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LabFlaskDimensions = {height: 20, width: 20}
