...
export const CreativeCommonsNoncommercialEu: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsNoncommercialEuDimensions = {height: 20, width: 20}
