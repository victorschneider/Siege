...
export const CreativeCommonsPublicDomain: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CreativeCommonsPublicDomainDimensions = {height: 20, width: 20}
