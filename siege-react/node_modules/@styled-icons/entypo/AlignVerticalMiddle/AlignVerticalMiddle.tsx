...
export const AlignVerticalMiddle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AlignVerticalMiddleDimensions = {height: 20, width: 20}
