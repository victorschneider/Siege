...
export const AirlineSeatReclineExtra: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AirlineSeatReclineExtraDimensions = {height: 24, width: 24}
