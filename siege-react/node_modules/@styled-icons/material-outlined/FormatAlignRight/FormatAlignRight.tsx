...
export const FormatAlignRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatAlignRightDimensions = {height: 24, width: 24}
