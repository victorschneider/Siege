...
export const QuestionAnswer: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuestionAnswerDimensions = {height: 24, width: 24}
