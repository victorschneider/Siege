...
export const HourglassEmpty: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HourglassEmptyDimensions = {height: 24, width: 24}
