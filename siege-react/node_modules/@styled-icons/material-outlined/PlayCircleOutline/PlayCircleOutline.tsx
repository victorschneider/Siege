...
export const PlayCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PlayCircleOutlineDimensions = {height: 24, width: 24}
