...
export const PictureInPicture: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PictureInPictureDimensions = {height: 24, width: 24}
