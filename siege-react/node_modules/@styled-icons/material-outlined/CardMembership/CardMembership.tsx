...
export const CardMembership: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CardMembershipDimensions = {height: 24, width: 24}
