...
export const DeveloperBoard: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DeveloperBoardDimensions = {height: 24, width: 24}
