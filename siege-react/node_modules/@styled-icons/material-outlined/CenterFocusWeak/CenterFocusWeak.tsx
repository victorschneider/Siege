...
export const CenterFocusWeak: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CenterFocusWeakDimensions = {height: 24, width: 24}
