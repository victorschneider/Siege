...
export const CheckBoxOutlineBlank: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheckBoxOutlineBlankDimensions = {height: 24, width: 24}
