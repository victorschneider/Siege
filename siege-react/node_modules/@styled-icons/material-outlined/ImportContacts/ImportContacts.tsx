...
export const ImportContacts: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ImportContactsDimensions = {height: 24, width: 24}
