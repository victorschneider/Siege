...
export const EditAttributes: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EditAttributesDimensions = {height: 24, width: 24}
