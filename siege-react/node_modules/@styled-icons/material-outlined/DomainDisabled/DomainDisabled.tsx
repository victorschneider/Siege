...
export const DomainDisabled: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DomainDisabledDimensions = {height: 24, width: 24}
