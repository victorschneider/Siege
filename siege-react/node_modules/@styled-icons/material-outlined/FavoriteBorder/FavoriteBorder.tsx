...
export const FavoriteBorder: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FavoriteBorderDimensions = {height: 24, width: 24}
