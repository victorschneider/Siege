...
export const SwapHorizontalCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SwapHorizontalCircleDimensions = {height: 24, width: 24}
