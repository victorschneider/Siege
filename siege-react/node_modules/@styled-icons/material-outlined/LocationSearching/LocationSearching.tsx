...
export const LocationSearching: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationSearchingDimensions = {height: 24, width: 24}
