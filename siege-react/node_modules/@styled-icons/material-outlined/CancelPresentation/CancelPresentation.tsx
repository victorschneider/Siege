...
export const CancelPresentation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CancelPresentationDimensions = {height: 24, width: 24}
