...
export const KeyboardBackspace: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeyboardBackspaceDimensions = {height: 24, width: 24}
