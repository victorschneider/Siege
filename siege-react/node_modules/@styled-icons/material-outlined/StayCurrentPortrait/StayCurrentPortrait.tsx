...
export const StayCurrentPortrait: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StayCurrentPortraitDimensions = {height: 24, width: 24}
