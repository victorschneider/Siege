...
export const Timer3: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const Timer3Dimensions = {height: 24, width: 24}
