...
export const InsertChartOutlined: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InsertChartOutlinedDimensions = {height: 24, width: 24}
