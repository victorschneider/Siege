...
export const StoreMallDirectory: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StoreMallDirectoryDimensions = {height: 24, width: 24}
