...
export const MarkunreadMailbox: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MarkunreadMailboxDimensions = {height: 24, width: 24}
