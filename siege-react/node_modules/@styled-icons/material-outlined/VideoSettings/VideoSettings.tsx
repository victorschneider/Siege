...
export const VideoSettings: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VideoSettingsDimensions = {height: 24, width: 24}
