...
export const LocationRestroom: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationRestroomDimensions = {height: 20, width: 20}
