...
export const CheveronOutlineDown: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheveronOutlineDownDimensions = {height: 20, width: 20}
