...
export const CheveronOutlineRight: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CheveronOutlineRightDimensions = {height: 20, width: 20}
