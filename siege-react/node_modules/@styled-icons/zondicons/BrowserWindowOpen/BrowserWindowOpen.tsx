...
export const BrowserWindowOpen: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BrowserWindowOpenDimensions = {height: 20, width: 20}
