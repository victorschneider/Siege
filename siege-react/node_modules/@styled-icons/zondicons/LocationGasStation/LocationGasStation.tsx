...
export const LocationGasStation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationGasStationDimensions = {height: 20, width: 20}
