...
export const IndentDecrease: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IndentDecreaseDimensions = {height: 20, width: 20}
