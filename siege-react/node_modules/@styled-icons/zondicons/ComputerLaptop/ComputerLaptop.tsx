...
export const ComputerLaptop: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ComputerLaptopDimensions = {height: 20, width: 20}
