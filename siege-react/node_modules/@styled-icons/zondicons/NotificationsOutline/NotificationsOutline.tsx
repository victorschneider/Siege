...
export const NotificationsOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NotificationsOutlineDimensions = {height: 20, width: 20}
