...
export const ExclamationOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ExclamationOutlineDimensions = {height: 20, width: 20}
