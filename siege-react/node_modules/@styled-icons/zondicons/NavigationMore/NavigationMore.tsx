...
export const NavigationMore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const NavigationMoreDimensions = {height: 20, width: 20}
