...
export const IndentIncrease: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const IndentIncreaseDimensions = {height: 20, width: 20}
