...
export const InformationOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const InformationOutlineDimensions = {height: 20, width: 20}
