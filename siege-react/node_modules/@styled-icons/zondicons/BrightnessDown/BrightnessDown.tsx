...
export const BrightnessDown: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BrightnessDownDimensions = {height: 20, width: 20}
