...
export const UserSolidSquare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const UserSolidSquareDimensions = {height: 20, width: 20}
