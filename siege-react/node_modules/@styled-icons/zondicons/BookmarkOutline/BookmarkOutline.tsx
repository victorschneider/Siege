...
export const BookmarkOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const BookmarkOutlineDimensions = {height: 20, width: 20}
