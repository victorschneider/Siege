...
export const FolderOutlineAdd: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FolderOutlineAddDimensions = {height: 20, width: 20}
