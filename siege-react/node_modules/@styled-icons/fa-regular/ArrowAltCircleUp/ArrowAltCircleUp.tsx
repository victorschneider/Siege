...
export const ArrowAltCircleUp: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ArrowAltCircleUpDimensions = {height: 512, width: 512}
