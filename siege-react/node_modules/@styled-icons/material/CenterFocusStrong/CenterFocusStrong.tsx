...
export const CenterFocusStrong: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CenterFocusStrongDimensions = {height: 24, width: 24}
