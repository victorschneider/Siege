...
export const KeyboardReturn: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeyboardReturnDimensions = {height: 24, width: 24}
