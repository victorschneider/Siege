...
export const PhonelinkSetup: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PhonelinkSetupDimensions = {height: 24, width: 24}
