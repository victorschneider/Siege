...
export const EnhancedEncryption: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EnhancedEncryptionDimensions = {height: 24, width: 24}
