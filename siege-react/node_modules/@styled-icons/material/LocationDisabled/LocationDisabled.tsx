...
export const LocationDisabled: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocationDisabledDimensions = {height: 24, width: 24}
