...
export const PausePresentation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PausePresentationDimensions = {height: 24, width: 24}
