...
export const AccessibleForward: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AccessibleForwardDimensions = {height: 24, width: 24}
