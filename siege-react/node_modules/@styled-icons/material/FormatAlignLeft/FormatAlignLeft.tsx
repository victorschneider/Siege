...
export const FormatAlignLeft: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatAlignLeftDimensions = {height: 24, width: 24}
