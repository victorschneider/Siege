...
export const DesktopWindows: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const DesktopWindowsDimensions = {height: 24, width: 24}
