...
export const LocalLaundryService: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocalLaundryServiceDimensions = {height: 24, width: 24}
