...
export const Sick: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SickDimensions = {height: 24, width: 24}
