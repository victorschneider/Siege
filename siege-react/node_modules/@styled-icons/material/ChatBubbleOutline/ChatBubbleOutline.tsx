...
export const ChatBubbleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChatBubbleOutlineDimensions = {height: 24, width: 24}
