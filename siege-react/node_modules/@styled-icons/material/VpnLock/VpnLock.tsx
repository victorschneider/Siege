...
export const VpnLock: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VpnLockDimensions = {height: 24, width: 24}
