...
export const RestoreFromTrash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RestoreFromTrashDimensions = {height: 24, width: 24}
