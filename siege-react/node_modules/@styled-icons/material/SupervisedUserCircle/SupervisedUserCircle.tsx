...
export const SupervisedUserCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SupervisedUserCircleDimensions = {height: 24, width: 24}
