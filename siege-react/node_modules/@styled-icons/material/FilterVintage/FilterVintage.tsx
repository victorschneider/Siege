...
export const FilterVintage: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FilterVintageDimensions = {height: 24, width: 24}
