...
export const FormatAlignJustify: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatAlignJustifyDimensions = {height: 24, width: 24}
