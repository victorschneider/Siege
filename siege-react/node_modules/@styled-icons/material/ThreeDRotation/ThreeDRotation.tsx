...
export const ThreeDRotation: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ThreeDRotationDimensions = {height: 24, width: 24}
