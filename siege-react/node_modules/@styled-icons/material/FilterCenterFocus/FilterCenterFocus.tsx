...
export const FilterCenterFocus: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FilterCenterFocusDimensions = {height: 24, width: 24}
