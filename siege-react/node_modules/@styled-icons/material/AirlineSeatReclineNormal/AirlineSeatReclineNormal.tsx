...
export const AirlineSeatReclineNormal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AirlineSeatReclineNormalDimensions = {height: 24, width: 24}
