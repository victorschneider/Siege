...
export const PauseCircleOutline: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PauseCircleOutlineDimensions = {height: 24, width: 24}
