...
export const ExposurePlus2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ExposurePlus2Dimensions = {height: 24, width: 24}
