...
export const MobileFriendly: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MobileFriendlyDimensions = {height: 24, width: 24}
