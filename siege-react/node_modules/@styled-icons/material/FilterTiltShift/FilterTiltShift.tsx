...
export const FilterTiltShift: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FilterTiltShiftDimensions = {height: 24, width: 24}
