...
export const PanoramaWideAngle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PanoramaWideAngleDimensions = {height: 24, width: 24}
