...
export const ElectricalServices: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ElectricalServicesDimensions = {height: 24, width: 24}
