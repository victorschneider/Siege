...
export const FormatTextdirectionRToL: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FormatTextdirectionRToLDimensions = {height: 24, width: 24}
