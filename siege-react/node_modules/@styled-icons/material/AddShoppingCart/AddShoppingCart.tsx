...
export const AddShoppingCart: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AddShoppingCartDimensions = {height: 24, width: 24}
