...
export const PortableWifiOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PortableWifiOffDimensions = {height: 24, width: 24}
