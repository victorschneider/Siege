...
export const VideogameAsset: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const VideogameAssetDimensions = {height: 24, width: 24}
