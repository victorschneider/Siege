...
export const FullscreenExit: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FullscreenExitDimensions = {height: 24, width: 24}
