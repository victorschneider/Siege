...
export const CalendarViewDay: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const CalendarViewDayDimensions = {height: 24, width: 24}
