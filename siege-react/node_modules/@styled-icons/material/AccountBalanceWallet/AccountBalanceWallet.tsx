...
export const AccountBalanceWallet: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AccountBalanceWalletDimensions = {height: 24, width: 24}
