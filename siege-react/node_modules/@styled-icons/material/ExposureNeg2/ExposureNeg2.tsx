...
export const ExposureNeg2: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ExposureNeg2Dimensions = {height: 24, width: 24}
