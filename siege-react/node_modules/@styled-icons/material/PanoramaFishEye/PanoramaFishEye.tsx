...
export const PanoramaFishEye: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PanoramaFishEyeDimensions = {height: 24, width: 24}
