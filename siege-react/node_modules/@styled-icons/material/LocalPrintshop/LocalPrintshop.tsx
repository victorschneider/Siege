...
export const LocalPrintshop: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LocalPrintshopDimensions = {height: 24, width: 24}
