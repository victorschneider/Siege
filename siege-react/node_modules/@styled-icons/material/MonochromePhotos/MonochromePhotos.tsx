...
export const MonochromePhotos: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <path fill="none" d="M0 0h24v24H0V0zM-74 29h48v48h-48V29z" />
...
export const MonochromePhotosDimensions = {height: 24, width: 24}
