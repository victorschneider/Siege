...
export const MobileScreenShare: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const MobileScreenShareDimensions = {height: 24, width: 24}
