...
export const SignalCellularNull: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SignalCellularNullDimensions = {height: 24, width: 24}
