...
export const KeyboardArrowLeft: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const KeyboardArrowLeftDimensions = {height: 24, width: 24}
