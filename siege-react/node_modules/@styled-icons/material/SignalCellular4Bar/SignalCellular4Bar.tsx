...
export const SignalCellular4Bar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const SignalCellular4BarDimensions = {height: 24, width: 24}
