...
export const HeadSideCoughSlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HeadSideCoughSlashDimensions = {height: 512, width: 640}
