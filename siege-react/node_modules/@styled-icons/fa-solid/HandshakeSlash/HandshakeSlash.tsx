...
export const HandshakeSlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HandshakeSlashDimensions = {height: 512, width: 640}
