...
export const StoreSlash: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const StoreSlashDimensions = {height: 512, width: 640}
