...
export const FileSignature: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileSignatureDimensions = {height: 512, width: 576}
