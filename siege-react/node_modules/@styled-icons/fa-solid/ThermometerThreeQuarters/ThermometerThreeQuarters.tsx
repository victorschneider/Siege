...
export const ThermometerThreeQuarters: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ThermometerThreeQuartersDimensions = {height: 512, width: 256}
