...
export const FileInvoiceDollar: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FileInvoiceDollarDimensions = {height: 512, width: 384}
