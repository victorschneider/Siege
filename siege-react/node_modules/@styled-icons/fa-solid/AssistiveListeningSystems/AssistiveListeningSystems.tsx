...
export const AssistiveListeningSystems: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const AssistiveListeningSystemsDimensions = {height: 512, width: 512}
