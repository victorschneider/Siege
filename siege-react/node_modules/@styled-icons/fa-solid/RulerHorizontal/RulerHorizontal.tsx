...
export const RulerHorizontal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const RulerHorizontalDimensions = {height: 512, width: 576}
