...
export const HeadphonesAlt: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const HeadphonesAltDimensions = {height: 512, width: 512}
