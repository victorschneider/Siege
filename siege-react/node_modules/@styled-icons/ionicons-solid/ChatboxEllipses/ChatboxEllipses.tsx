...
export const ChatboxEllipses: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChatboxEllipsesDimensions = {height: 512, width: 512}
