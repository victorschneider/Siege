...
export const LogoTwitch: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <rect width={48} height={129} x={320} y={143} />

      <rect width={48} height={129} x={208} y={143} />
...
export const LogoTwitchDimensions = {height: 512, width: 512}
