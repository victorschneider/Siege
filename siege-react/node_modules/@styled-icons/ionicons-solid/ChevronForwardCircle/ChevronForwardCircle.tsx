...
export const ChevronForwardCircle: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const ChevronForwardCircleDimensions = {height: 512, width: 512}
