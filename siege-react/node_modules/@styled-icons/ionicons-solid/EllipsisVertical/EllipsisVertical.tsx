...
export const EllipsisVertical: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EllipsisVerticalDimensions = {height: 512, width: 512}
