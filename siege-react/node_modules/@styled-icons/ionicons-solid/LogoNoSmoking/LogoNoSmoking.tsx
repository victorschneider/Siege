...
export const LogoNoSmoking: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <rect width={16} height={48} x={360} y={256} />
      ...
      <rect width={16} height={48} x={384} y={256} />
...
export const LogoNoSmokingDimensions = {height: 512, width: 512}
