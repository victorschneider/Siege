...
export const EllipsisHorizontal: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const EllipsisHorizontalDimensions = {height: 512, width: 512}
