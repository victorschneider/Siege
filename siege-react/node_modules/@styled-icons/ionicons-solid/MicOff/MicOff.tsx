...
export const MicOff: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
  ...
  return (
    <StyledIconBase
      ...
      ref={ref}
    >
      <line x1={432} x2={96} y1={400} y2={64} fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit={10} strokeWidth={32} />
...
export const MicOffDimensions = {height: 512, width: 512}
