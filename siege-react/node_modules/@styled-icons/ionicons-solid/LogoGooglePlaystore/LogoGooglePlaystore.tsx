...
export const LogoGooglePlaystore: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LogoGooglePlaystoreDimensions = {height: 512, width: 512}
