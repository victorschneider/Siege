...
export const LogoCapacitor: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const LogoCapacitorDimensions = {height: 512, width: 512}
