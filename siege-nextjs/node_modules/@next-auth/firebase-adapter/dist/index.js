...
import { addDoc, collection, deleteDoc, doc, getDoc, getDocs, getFirestore, limit, query, runTransaction, setDoc, where, connectFirestoreEmulator, } from "firebase/firestore";
import { getConverter } from "./converter";
export function FirestoreAdapter({ emulator, ...firebaseOptions }) {
    var _a, _b;
    const firebaseApp = initializeApp(firebaseOptions);
    const db = getFirestore(firebaseApp);
    if (emulator) {
        connectFirestoreEmulator(db, (_a = emulator === null || emulator === void 0 ? void 0 : emulator.host) !== null && _a !== void 0 ? _a : "localhost", (_b = emulator === null || emulator === void 0 ? void 0 : emulator.port) !== null && _b !== void 0 ? _b : 3001);
    }
    ...
    const VerificationTokens = collection(db, "verificationTokens").withConverter(getConverter({ excludeId: true }));
    return {
